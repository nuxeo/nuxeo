...
public interface PublicationHelper extends Serializable{
    ...
    /* (non-Javadoc)
     * @see org.nuxeo.ecm.platform.jbpm.core.helper.PublicationHelper#publishDocument(org.nuxeo.ecm.core.api.CoreSession, org.nuxeo.ecm.core.api.DocumentModel, org.nuxeo.ecm.core.api.DocumentModel)
     */
    void publishDocument(CoreSession session, DocumentModel docToPublish,
            DocumentModel secionToPublish) throws ClientException;

    /* (non-Javadoc)
     * @see org.nuxeo.ecm.platform.jbpm.core.helper.PublicationHelper#assign(org.jbpm.taskmgmt.exe.Assignable, org.jbpm.graph.exe.ExecutionContext)
     */
