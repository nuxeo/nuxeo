...
public class WebSSOProfile extends SAMLProfile {
    ...
    public WebSSOProfile(IDPSSODescriptor idpSSO) {
        super();
    ...
    public SAMLCredential processAuthenticationResponse(SAMLMessageContext context) throws SAMLException {
        ...
        return new SAMLCredential(nameID, context.getPeerEntityMetadata().getEntityID(), context.getRelayState(), attributes, context.getLocalEntityId(), additionalData);

    }

    public AuthnRequest buildAuthRequest() throws SAMLException {
        ...
        if (ssoService.getResponseLocation() != null) {
            ...
            request.setAssertionConsumerServiceURL(ssoService.getLocation());
        }
