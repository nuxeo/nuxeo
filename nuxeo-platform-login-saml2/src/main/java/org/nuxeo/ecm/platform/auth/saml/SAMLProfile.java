...
public abstract class SAMLProfile {
    protected final static Log log = LogFactory.getLog(SAMLProfile.class);
    ...
    public abstract SAMLCredential processAuthenticationResponse(SAMLMessageContext context) throws SAMLException, SecurityException, ValidationException, DecryptionException;
