 ...
 * @version $Revision: 1 $
 */
public class ConstructorInjectorImpl extends AbstractInjector  implements ConstructorInjector
{
   ...
   public ConstructorInjectorImpl(Constructor constructor, PathParamIndex index, ResteasyProviderFactory factory)
   {
      ...
      for (int i = 0; i < constructor.getParameterTypes().length; i++)
      {
         ...
         params[i] = getParameterExtractor(index, type, genericType, annotations, constructor, factory);
      }
   }
