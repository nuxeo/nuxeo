...
import org.nuxeo.ecm.webengine.rest.servlet.jersey.patch.ServletContainer;
...
public class WebEngineServlet extends ServletContainer {
    ...
    protected ContainerRequest createContainerRequest(HttpServletRequest request,
        ...
        return new org.nuxeo.ecm.webengine.rest.servlet.jersey.patch.ServletContainerRequest(
                request,
                _application,
                request.getMethod(),
                baseUri,
