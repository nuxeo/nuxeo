 ...
 * @version $Revision: 1 $
 */
public class PropertyInjectorImpl extends AbstractInjector  implements PropertyInjector
{
   ...
   protected void populateMap(Class clazz, PathParamIndex index, ResteasyProviderFactory factory)
   {
      for (Field field : clazz.getDeclaredFields())
      {
         ...
         ValueInjector extractor = getParameterExtractor(index, type, genericType, annotations, field, factory);
      ...
      for (Method method : clazz.getDeclaredMethods())
      {
         ...
         ValueInjector extractor = getParameterExtractor(index, type, genericType, annotations, method, factory);
         if (!(extractor instanceof MessageBodyParameterInjector))
         {
            long hash = 0;
            try
