  ...
  <tr>
    <#list themes as theme>
      <td class='ltab ${theme.className}'><img alt="" width="5" height="5"
        src="/skin/nxthemes-editor/img/l-theme-tab.png" /></td>
      ...
      <td class='rtab ${theme.className}'><img alt="" width="5" height="5"
        src="/skin/nxthemes-editor/img/r-theme-tab.png" /></td>
      <td class="separator"></td>
    </#list>
    <td class="ltab"><img alt="" width="5" height="5" src="/skin/nxthemes-editor/img/l-theme-tab.png" /></td>
    <td class="tab"><a href="javascript:void(0)" onclick="javascript:NXThemesEditor.addTheme()"> + </a></td>
    <td class="rtab"><img alt="" width="5" height="5" src="/skin/nxthemes-editor/img/r-theme-tab.png" /></td>
  </tr>
</table>
