 ...
 *
 */
public class ReloadableSingletonFactory implements ResourceFactory {

    protected ClassProxy classp;
    protected Object obj;
    
    public ReloadableSingletonFactory(ClassProxy classp) {
        try {
            obj = classp.get().newInstance();
        } catch (Exception e) {
    ...
    public Object createResource(HttpRequest request, HttpResponse response,
        ...
        Class<?> c = classp.get(); // reload if needed
        if (c != obj.getClass()) {
            try {
                obj = c.newInstance();
            } catch (Exception e) {
