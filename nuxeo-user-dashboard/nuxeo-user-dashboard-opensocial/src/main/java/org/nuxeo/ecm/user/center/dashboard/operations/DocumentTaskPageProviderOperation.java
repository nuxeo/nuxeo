 ...
 * @since 5.4.2
 */
@Operation(id = DocumentTaskPageProviderOperation.ID, category = Constants.CAT_FETCH, label = "UserTaskPageProvider", description = "Returns the tasks waiting for the current user.")
