...
import org.nuxeo.ecm.platform.imaging.api.IMetadata;
 ...
 * @author Max Stepanov
 */
public class MetadataUtils implements IMetadata {
    ...
    public static Map<String, Object> getImageMetadata(InputStream in) {
        return getImageMetadataInternal(in);
    }

    public static Map<String, Object> getImageMetadata(File file) {
