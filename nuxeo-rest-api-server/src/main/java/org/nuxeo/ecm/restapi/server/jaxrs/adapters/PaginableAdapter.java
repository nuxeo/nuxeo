...
public abstract class PaginableAdapter extends DefaultAdapter{
    ...
    protected void initialize(Object... args) {
        ...
        page = extractLongParam("page", 0L);
        pageSize = extractLongParam("pageSize", 50L);

        maxResults = info.getQueryParameters().getFirst("maxResults");
    ...
    protected Long extractLongParam(String paramName,
            Long defaultValue) {
        String strParam = info.getQueryParameters().getFirst(paramName);
