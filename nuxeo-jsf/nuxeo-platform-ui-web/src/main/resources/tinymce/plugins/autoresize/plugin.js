...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_1x8e688cje4cbvzi.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_1x8e688cje4cbvzi.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_1x8e688cje4cbvzi.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_1x8e688cje4cbvzi.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_1x8e688cje4cbvzi.getAutoResizeBottomMargin(editor);
    ...
    if ($_1x8e688cje4cbvzi.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_gew83289je4cbvze.resize(editor, oldSize);
    });
  };
  var $_966hte88je4cbvzd = { register: register };

  PluginManager.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_966hte88je4cbvzd.register(editor, oldSize);
      $_gew83289je4cbvze.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
