...
var spellchecker = (function () {
  ...
  var $_evlyczizje4cbxgw = { hasProPlugin: hasProPlugin };
  ...
  var defaultSpellcheckCallback = function (editor, pluginUrl, currentLanguageState) {
    return function (method, text, doneCallback, errorCallback) {
      ...
      XHR.send({
        url: new URI(pluginUrl).toAbsolute($_bmmx6ij1je4cbxgy.getRpcUrl(editor)),
        type: 'post',
        ...
        error: function () {
          var message = editor.translate('The spelling service was not found: (') + $_bmmx6ij1je4cbxgy.getRpcUrl(editor) + editor.translate(')');
          errorCallback(message);
        }
      });
    };
  ...
  var sendRpcCall = function (editor, pluginUrl, currentLanguageState, name, data, successCallback, errorCallback) {
    var userSpellcheckCallback = $_bmmx6ij1je4cbxgy.getSpellcheckerCallback(editor);
  ...
  var finish = function (editor, startedState, textMatcherState) {
    ...
    if (startedState.get()) {
      ...
      $_4xqkzbj6je4cbxh6.fireSpellcheckEnd(editor);
      return true;
    }
  };
  ...
  var markErrors = function (editor, startedState, textMatcherState, lastSuggestionsState, data) {
    ...
    getTextMatcher(editor, textMatcherState).find($_bmmx6ij1je4cbxgy.getSpellcheckerWordcharPattern(editor)).filter(function (match) {
    ...
    $_4xqkzbj6je4cbxh6.fireSpellcheckStart(editor);
  };
  var $_3bp2tnj2je4cbxh1 = {
  ...
  var get = function (editor, startedState, lastSuggestionsState, textMatcherState, url) {
    var getLanguage = function () {
      return $_bmmx6ij1je4cbxgy.getLanguage(editor);
    };
    var getWordCharPattern = function () {
      return $_bmmx6ij1je4cbxgy.getSpellcheckerWordcharPattern(editor);
    };
    var markErrors = function (data) {
      $_3bp2tnj2je4cbxh1.markErrors(editor, startedState, textMatcherState, lastSuggestionsState, data);
    };
  ...
  var $_fcx4p6j0je4cbxgx = { get: get };

  var register = function (editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState) {
    editor.addCommand('mceSpellCheck', function () {
      $_3bp2tnj2je4cbxh1.spellcheck(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
    });
  };
  var $_75tjpaj8je4cbxhg = { register: register };
  ...
  var updateSelection = function (editor) {
    return function (e) {
      var selectedLanguage = $_bmmx6ij1je4cbxgy.getLanguage(editor);
  ...
  var getItems = function (editor) {
    return Tools.map($_bmmx6ij1je4cbxgy.getLanguages(editor).split(','), function (langPair) {
  ...
  var $_bcf4udj9je4cbxhi = { register: register$1 };
  ...
  var showSuggestions = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState, word, spans) {
    ...
    Tools.each(suggestions, function (suggestion) {
      items.push({
        ...
        onclick: function () {
          ...
          $_3bp2tnj2je4cbxh1.checkIfFinished(editor, startedState, textMatcherState);
        }
      });
    });
    items.push({ text: '-' });
    ...
    if (hasDictionarySupport) {
      items.push({
        ...
        onclick: function () {
          $_3bp2tnj2je4cbxh1.addToDictionary(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, word, spans);
        }
      });
    }
    items.push.apply(items, [
      {
        text: 'Ignore',
        onclick: function () {
          $_3bp2tnj2je4cbxh1.ignoreWord(editor, startedState, textMatcherState, word, spans);
        }
      },
      {
        text: 'Ignore all',
        onclick: function () {
          $_3bp2tnj2je4cbxh1.ignoreWord(editor, startedState, textMatcherState, word, spans, true);
        }
      }
    ]);
  ...
  var setup = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState) {
    editor.on('click', function (e) {
      ...
      if (target.className === 'mce-spellchecker-word') {
        e.preventDefault();
        var spans = $_3bp2tnj2je4cbxh1.findSpansByIndex(editor, $_3bp2tnj2je4cbxh1.getElmIndex(target));
        if (spans.length > 0) {
          var rng = editor.dom.createRng();
  ...
  var $_233ty9jaje4cbxhk = { setup: setup };

  PluginManager.add('spellchecker', function (editor, pluginUrl) {
    if ($_evlyczizje4cbxgw.hasProPlugin(editor) === false) {
      var startedState = Cell(false);
      var currentLanguageState = Cell($_bmmx6ij1je4cbxgy.getLanguage(editor));
      var textMatcherState = Cell(null);
      var lastSuggestionsState = Cell({});
      $_bcf4udj9je4cbxhi.register(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, lastSuggestionsState);
      $_233ty9jaje4cbxhk.setup(editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState);
      $_75tjpaj8je4cbxhg.register(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
      return $_fcx4p6j0je4cbxgx.get(editor, startedState, lastSuggestionsState, textMatcherState, pluginUrl);
    }
  });
  function Plugin () {
  }
