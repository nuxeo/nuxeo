...
var emoticons = (function () {
  ...
  var $_2bs7eahje4cbw88 = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_2bs7eahje4cbw88.getHtml(pluginUrl);
  ...
  var $_5ymiksagje4cbw86 = { register: register };

  PluginManager.add('emoticons', function (editor, pluginUrl) {
    $_5ymiksagje4cbw86.register(editor, pluginUrl);
  });
  function Plugin () {
  }
