...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_7tojdwe5je4cbwu1.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_7tojdwe5je4cbwu1.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_7tojdwe5je4cbwu1.getSelectorConverter(editor)) {
      selectorConverter = $_7tojdwe5je4cbwu1.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_7tojdwe5je4cbwu1.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_7tojdwe5je4cbwu1.getCssGroups(editor));
      ...
      if (!$_7tojdwe5je4cbwu1.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      Tools.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_7tojdwe5je4cbwu1.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_57sr0ae0je4cbwtr.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_cvttd2dzje4cbwto = { get: get };

  PluginManager.add('importcss', function (editor) {
    $_57sr0ae0je4cbwtr.setup(editor);
    return $_cvttd2dzje4cbwto.get(editor);
  });
  function Plugin () {
  }
