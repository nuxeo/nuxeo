...
import org.nuxeo.ecm.platform.transform.plugin.poi.WordToTextPlugin;
...
public class TestWordToTextPlugin extends AbstractPluginTestCase {
    ...
    private WordToTextPlugin plugin;

    @Override
    public void setUp() throws Exception {
        super.setUp();
        plugin = (WordToTextPlugin) service.getPluginByName("word2text_poi");
    }
