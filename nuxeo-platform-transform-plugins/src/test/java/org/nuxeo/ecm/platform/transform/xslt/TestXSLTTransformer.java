...
/**
 * Test the XSLTPlugin by using the transformer.
 *
 * @author <a href="mailto:troger@nuxeo.com">Thomas Roger</a>
 *
 */
public class TestXSLTTransformer extends AbstractXSLTPluginTest {
    ...
    public void setUp() throws Exception {
        super.setUp();
        transformer = service.getTransformerByName(PLUGIN_NAME);
    }
    ...
    public void testSimpleHtmlXSLTransformation() throws Exception {
        ...
        assertEquals("wrong mimetype", "text/html",
                result.getMimeType());

        final InputStream expected = new FileInputStream(FileUtils.getResourceFileFromContext(expectedSource));
    ...
    public void testSimpleXMLXSLTransformation() throws Exception {
        ...
        final Blob result =results.get(0).getBlob();
        assertEquals("wrong mimetype", "text/xml",
                result.getMimeType());
