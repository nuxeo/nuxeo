 ...
 *
 */
public class IndexingSingleDocumentThread extends Thread implements IndexingThread {

    private static final Log log = LogFactory.getLog(IndexingSingleDocumentThread.class);
    ...
    public IndexingSingleDocumentThread(Runnable r) {
        super(r);
