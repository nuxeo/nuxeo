...
/**
 * /nuxeo/diffPictures?&action=diff&repo=therepo&leftDocId=123456&rightDocId=
 * 456789012
 * &xpath=file:content&commandLine=thecommandline&fuzz=1000&highlightColor=
 * Red&lowlightColor=White
 * 
 * Depending on the value of "action", other parameters are used or not
 * <ul>
 * <li>diff
 * <ul>
 ...
 * <li>All other parameters are optional (commandLine, xpath, fuzz, ...).
 * Default values are defined in <code>DiffPictures</code></li>
 * </ul>
 * </li>
 * <li>cleanup
 * <ul>
 ...
 * </ul>
 * 
 * commandine, xpath, fuzz, highlightColor, lowlightColor and repo are optional
 * 
 * Utility to force cleanup of temporary files created on the server:
 * /nuxeo/diffPictures?cleanup=true&leftDocId=123456&rightDocId=456789&
 * 
...
public class DiffPicturesServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if (StringUtils.isBlank(repo)) {
			repo = Framework.getLocalService(RepositoryManager.class)
