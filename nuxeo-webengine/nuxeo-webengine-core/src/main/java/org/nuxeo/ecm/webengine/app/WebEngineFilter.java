...
public class WebEngineFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        new Config((HttpServletRequest) request, (HttpServletResponse)response).doFilter(chain);
    }
    ...
    static class Config {
        ...
        Config(HttpServletRequest req, HttpServletResponse resp) throws IOException {
