...
a Java 5 or Java 6 JDK on your computer)

2. go to nuxeo-webengine-server/target and unzip nuxeo-server.zip

3. start the server by typing "sh nxserver.sh" (Unix/Linux) or "nxserver"
(Windows).

You can now point your browser to http://localhost:8080/ ans start playing with
Nuxeo WebEngine.
