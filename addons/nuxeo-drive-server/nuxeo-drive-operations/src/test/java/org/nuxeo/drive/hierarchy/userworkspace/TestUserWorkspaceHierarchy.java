...
public class TestUserWorkspaceHierarchy {
    ...
    public void testClientSideUser1() throws Exception {
        ...
        // ---------------------------------------------
        // user1Folder1
        DocumentBackedFolderItem folderItem = mapper.readValue(topLevelChildren.get(0), DocumentBackedFolderItem.class);
        ...
        // user1File2
        DocumentBackedFileItem fileItem = mapper.readValue(topLevelChildren.get(1), DocumentBackedFileItem.class);
        ...
        // ---------------------------------------------
        // My synchronized folders
        UserWorkspaceSyncRootParentFolderItem syncRootParent = mapper.readValue(topLevelChildren.get(2),
