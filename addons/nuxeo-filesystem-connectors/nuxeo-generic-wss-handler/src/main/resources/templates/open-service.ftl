...
<body>
<p>method=open service:${request.version}
<p>service=
<ul>
...
<li>IX|1
<li>vti_toolpaneurl
<li>SX|${request.getBaseUrl("layouts")}toolpane.aspx
...
<li>SX|${request.getBaseUrl("catalogs")}masterpage/default.master
...
<li>vti_servertz
<li>SX|${config.TZOffset}
<li>vti_adminurl
<li>SX|${request.getBaseUrl("layouts")}settings.aspx
