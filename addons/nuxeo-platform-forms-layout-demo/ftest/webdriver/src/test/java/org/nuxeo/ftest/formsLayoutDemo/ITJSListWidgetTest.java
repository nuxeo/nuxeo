...
import org.nuxeo.functionaltests.formsLayoutDemo.page.standardWidgets.JSListStandardWidgetPage;
...
public class ITJSListWidgetTest extends AbstractTest {
    ...
    JSListStandardWidgetPage page;

    @Before
    public void setUp() {
        driver.get(HomePage.URL);
        page = get(HomePage.URL + "listWidget", JSListStandardWidgetPage.class);
