...
@Deploy("org.nuxeo.ecm.liveconnect.google.drive.core:OSGI-INF/cache-config.xml")
@Deploy("org.nuxeo.ecm.liveconnect.google.drive.core:OSGI-INF/core-types-contrib.xml")
@Deploy("org.nuxeo.ecm.liveconnect.google.drive.core.test:OSGI-INF/test-googledrive-config.xml")
@Deploy("org.nuxeo.ecm.liveconnect.google.drive.core:OSGI-INF/googledrive-pageprovider-contrib.xml")
