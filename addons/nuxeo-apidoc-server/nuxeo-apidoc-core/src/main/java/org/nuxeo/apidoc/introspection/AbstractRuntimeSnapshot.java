...
public abstract class AbstractRuntimeSnapshot extends BaseNuxeoArtifact
    ...
    public AbstractRuntimeSnapshot() {
        super();
    }

    public abstract void initOperations();

    protected abstract Collection<BundleInfoImpl> getBundles();

    protected synchronized void initSnapshot() {
        created = new Date();
        for (BundleInfoImpl bInfo : getBundles()) {
        ...
        for (String grpId : mavenGroups.keySet()) {
            BundleGroupImpl bGroup = buildBundleGroup(grpId, getVersion());
    ...
    public List<String> getBundleIds() {
        ...
        for (BundleInfoImpl info : getBundles()) {
    ...
    public BundleInfoImpl getBundle(String id) {
        ...
        for (BundleInfoImpl bi : getBundles()) {
