...
@Deploy({ "org.nuxeo.ecm.platform.filemanager.api", "org.nuxeo.ecm.platform.filemanager.core",
        "org.nuxeo.ecm.actions", "org.nuxeo.ecm.platform.routing.core:OSGI-INF/test-route-contrib.xml" })
