...
chmod +x nuxeo-platform-document-routing-distribution/target/nuxeo-cm-server/bin/nuxeoctl || exit 1
nuxeo-platform-document-routing-distribution/target/nuxeo-cm-server/bin/nuxeoctl start || exit 1
...
# Strop JBoss
nuxeo-platform-document-routing-distribution/target/nuxeo-cm-server/bin/nuxeoctl stop || exit 1
