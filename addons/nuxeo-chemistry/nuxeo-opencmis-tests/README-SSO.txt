...
* add the cas and portal-sso plugins in nxserver plugins folder (http://qa.nuxeo.org/hudson/view/NX%205.4.2-HF110addons/job/addons_nuxeo-platform-login-5.4/ws)
