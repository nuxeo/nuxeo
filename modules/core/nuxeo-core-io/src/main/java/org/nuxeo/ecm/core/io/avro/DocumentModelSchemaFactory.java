...
public class DocumentModelSchemaFactory extends AvroSchemaFactory<DocumentModel> {
    ...
    public Schema createSchema(DocumentModel input) {
        ...
        schema.setFields(Arrays.asList(
                ...
                new Field(AvroConstants.IS_RECORD, Schema.create(Type.BOOLEAN), null, Boolean.FALSE),
                new Field(AvroConstants.HAS_LEGAL_HOLD, Schema.create(Type.BOOLEAN), null, Boolean.FALSE),
                // nullable
