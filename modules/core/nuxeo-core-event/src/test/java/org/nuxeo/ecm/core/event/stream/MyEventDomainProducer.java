 ...
 * @since 11.1
 */
public class MyEventDomainProducer extends EventDomainProducer {
    private static final Logger log = LogManager.getLogger(MyEventDomainProducer.class);

    List<Record> records = new ArrayList<>();

    public MyEventDomainProducer(String name, String stream) {
        super(name, stream);
