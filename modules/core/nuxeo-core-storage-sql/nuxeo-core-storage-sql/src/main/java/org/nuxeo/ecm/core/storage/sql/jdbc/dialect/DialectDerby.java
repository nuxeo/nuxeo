...
public class DialectDerby extends Dialect {
    ...
    public JDBCInfo getJDBCTypeAndString(ColumnType type) {
        ...
        case AUTOINC:
            return jdbcInfo("INTEGER GENERATED BY DEFAULT AS IDENTITY", Types.INTEGER);
        case FTINDEXED:
            return jdbcInfo("CLOB", Types.CLOB);
        case FTSTORED:
            return jdbcInfo("CLOB", Types.CLOB);
    ...
    public String addPagingClause(String sql, long limit, long offset) {
        return sql + String.format(" OFFSET %d ROWS FETCH FIRST %d ROWS ONLY", offset, limit); // available from 10.5
    }
