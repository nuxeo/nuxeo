...
public class StreamIntrospectionPlantUMLWriterTest
        extends AbstractPlantUMLWriterTest.Local<StreamIntrospectionPlantUMLWriter, StreamIntrospection> {

    @Test
    public void testEmptyIntrospection() throws IOException {
        var streamIntrospection = getJsonAsStreamIntrospection("{}");
        String puml = asPuml(streamIntrospection);
        assertTrue(puml, puml.contains("@startuml"));
    }

    @Test
    public void testPumlConversion() throws IOException {
    ...
    @Test
    public void testPumlConversionSimple() throws IOException {
