...
public class TestDownloadService {
    ...
    protected void doTestBasicDownload(boolean head, boolean inline) throws Exception {
        ...
        // non-ascii filename gets RFC 2231 encoding with an ASCII fallback (RFC 6266 Appendix D)
        doTestBasicDownload(head, inline, "caf\u00e9.txt", "filename=cafe.txt; filename*=UTF-8''caf%C3%A9.txt");
    }
