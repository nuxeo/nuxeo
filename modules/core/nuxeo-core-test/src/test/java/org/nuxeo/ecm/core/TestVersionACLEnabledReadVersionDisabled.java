...
@Deploy("org.nuxeo.ecm.core.test.tests:OSGI-INF/version-acl-enabled.xml")
@Deploy("org.nuxeo.ecm.core.test.tests:OSGI-INF/version-readversion-disabled.xml")
public class TestVersionACLEnabledReadVersionDisabled extends TestVersionACLAbstract {

    @Override
    protected VersionAclMode getVersionAclMode() {
        return VersionAclMode.ENABLED;
    }
