...
/**
 * The implementation of {@link ESHintQueryBuilder} for the <strong>"regex"</strong> Elasticsearch hint operator.
 *
 * @since 11.1
 */
public class RegexESHintQueryBuilder implements ESHintQueryBuilder {

    /**
     * {@inheritDoc}
     * <p>
     *
     * @return {@link org.elasticsearch.index.query.RegexpQueryBuilder}
     */
    @Override
