...
public interface DocumentRoutingEscalationService {
     ...
     * @since 2023.0
     */
    boolean isExecutionRunning(String repositoryName);
     ...
     * @since 2023.0
     */
    void setExecutionRunning(String repositoryName);
     ...
     * @since 2023.0
     */
    List<EscalationRule> computeEscalationRulesToExecute(GraphNode node, boolean handleTransaction);
     ...
     * @since 2023.0
     */
    void executeEscalationRule(EscalationRule rule, boolean handleTransaction);
