...
public interface AnnotationService {
    ...
    default Annotation getExternalAnnotation(CoreSession session, String entityId)
            throws CommentNotFoundException, CommentSecurityException {
     ...
     */
    @Deprecated(since = "11.1")
    default void updateExternalAnnotation(CoreSession session, String entityId, Annotation annotation)
            throws CommentNotFoundException, CommentSecurityException {
     ...
     */
    @Deprecated(since = "11.1")
    default void deleteExternalAnnotation(CoreSession session, String entityId)
            throws CommentNotFoundException, CommentSecurityException {
