...
public class CommentNotificationVeto implements NotificationListenerVeto {
    ...
    protected static final Set<String> ACCEPTED_COMMENT_TYPE = Set.of(COMMENT_DOC_TYPE, ANNOTATION_DOC_TYPE, "Post");

    protected static final Set<String> EXCLUDED_EVENT_TYPES = Set.of(DOCUMENT_CREATED, DOCUMENT_UPDATED,
            DOCUMENT_REMOVED);
