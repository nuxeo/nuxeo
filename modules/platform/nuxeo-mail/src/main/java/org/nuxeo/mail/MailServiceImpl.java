...
public class MailServiceImpl extends DefaultComponent implements MailService {
    ...
    public void sendMail(MailMessage msg) {
        ...
        if (senders.containsKey(senderName)) {
            ...
            throw new MailException("Couldn't send mail. MailSender: " + senderName + " not found");
        }
    }

    /**
     * @return the sender name to use in {@link MailMessage}
     * @deprecated since 2023.4 This is a fallback method to register a {@link JndiSMTPMailSender} on the fly when only
