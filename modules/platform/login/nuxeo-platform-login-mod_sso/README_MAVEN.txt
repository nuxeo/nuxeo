...
For some unknow reason, this project can't be build using the sar dependency.
=> compilation failed

For now, the only solution to build is to depend on nuxeo-ecm-login jar as the dependecy on sar does not work.
