...
public class DefaultSignatureAppearanceFactory implements SignatureAppearanceFactory {
    ...
    @Override
    public void format(PdfSignatureAppearance pdfSignatureAppearance, DocumentModel doc, String principal,
            String reason) {
        ...
        Font layer2Font = FontFactory.getFont(FontFactory.TIMES, layout.getTextSize(), Font.NORMAL,
