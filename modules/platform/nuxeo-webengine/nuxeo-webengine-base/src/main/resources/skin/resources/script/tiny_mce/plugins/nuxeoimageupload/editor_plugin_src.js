(function() {
        ...
        tinymce.PluginManager.requireLangPack('nuxeoimageupload');

        tinymce.create('tinymce.plugins.NuxeoImageUploadPlugin', {
                ...
                init : function(ed, url) {
                        ...
                        ed.addButton('nuxeoimageupload', {
                                title : 'nuxeoimageupload.desc',
                                cmd : 'mceNuxeoImageUpload',
        ...
        // Register plugin
        tinymce.PluginManager.add('nuxeoimageupload', tinymce.plugins.NuxeoImageUploadPlugin);
})();