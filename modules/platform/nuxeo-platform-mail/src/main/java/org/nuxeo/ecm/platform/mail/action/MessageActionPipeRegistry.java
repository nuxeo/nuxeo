 ...
 * @since 11.5
 */
public class MessageActionPipeRegistry extends MapRegistry<MessageActionPipeDescriptor> {

    @Override
    protected boolean shouldMerge(Context ctx, XAnnotatedObject<MessageActionPipeDescriptor> xObject, Element element,
            String extensionId, String id, Object existing) {
        if (element.hasAttribute("override")) {
            ...
            MessageActionPipeDescriptor ob = xObject.newInstance(ctx, element);
            return !ob.override;
        }
    ...
    @Override
    protected MessageActionPipeDescriptor doRegister(Context ctx, XAnnotatedObject<MessageActionPipeDescriptor> xObject,
            Element element, String extensionId) {
