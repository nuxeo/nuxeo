 ...
 * @since 11.5
 */
public class SingleRuntimeRegistry extends SingleRegistry implements RuntimeRegistryLogger {

    private static final Logger log = LogManager.getLogger(SingleRuntimeRegistry.class);
