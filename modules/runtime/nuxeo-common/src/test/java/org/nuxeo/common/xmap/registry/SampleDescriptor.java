...
public class SampleDescriptor {
    ...
    @XNode(value = "bool", defaultValue = "true")
    boolean bool;
    ...
    @XMerge(value = "stringListAnnotated@append", fallbackValue = "stringListAnnotated"
            + XMerge.MERGE, defaultValue = true)
    ...
    @XMerge(value = "stringMapAnnotated" + XMerge.MERGE, defaultValue = false)
