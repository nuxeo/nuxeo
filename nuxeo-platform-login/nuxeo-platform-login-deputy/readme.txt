...
Users may use their mandates and re-connect themself using the mandated permissions (>Deputis/My mandates).

Technicaly, the reconnection is managed by redirecting the client to the switch user page.  
The mandated user login is tranfered to the serer using an attribute
