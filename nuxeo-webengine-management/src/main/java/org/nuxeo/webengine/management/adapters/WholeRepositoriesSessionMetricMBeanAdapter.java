 ...
 */
public class WholeRepositoriesSessionMetricMBeanAdapter implements WholeRepositoriesSessionMetricMBean {

    @SuppressWarnings("unused")
    private static final Log log = LogFactory.getLog(WholeRepositoriesSessionMetricMBeanAdapter.class);

    public WholeRepositoriesSessionMetricMBeanAdapter(RepositoryManager manager) {
