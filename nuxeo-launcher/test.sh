...
NUXEO_HOME=${NUXEO_HOME:-$(cd $(dirname $0); cd ../nuxeo-distribution-tomcat/target/nuxeo-cap-5.7.3-tomcat; pwd -P)}
...
cp target/nuxeo-launcher-5.7.3-jar-with-dependencies.jar "$NUXEO_HOME"/bin/nuxeo-launcher.jar
