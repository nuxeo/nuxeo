...
NUXEO_HOME=${NUXEO_HOME:-$(cd $(dirname $0); cd ../nuxeo-distribution-tomcat/target/nuxeo-cap-5.8.0-HF17-SNAPSHOT-tomcat; pwd -P)}
...
cp target/nuxeo-launcher-5.8.0-HF17-SNAPSHOT-jar-with-dependencies.jar "$NUXEO_HOME"/bin/nuxeo-launcher.jar
