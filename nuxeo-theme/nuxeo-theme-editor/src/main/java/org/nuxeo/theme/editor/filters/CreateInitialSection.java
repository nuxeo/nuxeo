...
public final class CreateInitialSection extends StandaloneFilter {
    ...
    public RenderingInfo process(final RenderingInfo info, final boolean cache) {
        ...
        html.append("<img class=\"nxthemesAddSection\" src=\"/nuxeo/nxthemes/editor/img/add.png\" ")
            .append("onmouseover=\"this.src='/nuxeo/nxthemes/editor/img/add-hover.png'\" ")
            .append("onmouseout=\"this.src='/nuxeo/nxthemes/editor/img/add.png'\" ")
            .append("sectionid=\"")
