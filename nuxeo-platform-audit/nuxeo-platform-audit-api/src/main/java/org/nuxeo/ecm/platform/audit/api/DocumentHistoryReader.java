...
public interface DocumentHistoryReader {
     ...
     * @throws Exception
     */
    List<LogEntry> getDocumentHistory(DocumentModel doc, long pageIndex, long pageSize) throws Exception;
     ...
     * @throws Exception
     */
    PageProvider<LogEntry> getPageProvider(DocumentModel doc, long pageIndex,long pageSize) throws Exception;
}
