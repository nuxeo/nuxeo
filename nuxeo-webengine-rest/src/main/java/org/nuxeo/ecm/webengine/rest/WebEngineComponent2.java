...
import org.nuxeo.ecm.webengine.ConfigurationFileDescriptor;
import org.nuxeo.ecm.webengine.DefaultWebEngine;
import org.nuxeo.ecm.webengine.WebApplicationMapping;
import org.nuxeo.ecm.webengine.WebEngine;
import org.nuxeo.ecm.webengine.WebObjectBindingDescriptor;
 ...
 *
 */
public class WebEngineComponent2 extends ManagedComponent implements ConfigurationChangedListener {

    public static final ComponentName NAME = new ComponentName(WebEngineComponent2.class.getName());
    ...
    private static final Log log = LogFactory.getLog(WebEngineComponent2.class);

    private WebEngine2 engine;
...
//        registerContributionManager(WEB_OBJ_XP, new ContributionManager(this));
        ...
        engine = new WebEngine2(root, notifier);
...
//TODO            engine.fireConfigurationChanged();
        }
    }
