 ...
 * @author sfermigier
 */
public class TestSerializableArrayMap extends TestCase {

    public void test() {
        SerializableArrayMap<String, String> am = new SerializableArrayMap<String, String>();
        ...
        SerializableArrayMap<String, String> am2 = new SerializableArrayMap<String, String>(am);
        ...
        SerializableArrayMap<String, String> am3 = new SerializableArrayMap<String, String>(am2);
        am2.trimToSize();
