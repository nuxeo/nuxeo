...
import org.nuxeo.ecm.platform.test.web.finder.Finder;
import org.nuxeo.ecm.platform.test.web.finder.IdFinder;
import org.nuxeo.ecm.platform.test.web.finder.LinkFinder;
import org.nuxeo.ecm.platform.test.web.finder.XPathFinder;
import org.nuxeo.ecm.platform.test.web.finder.XPathManyFinder;
...
public class AbstractPage implements WebPage {
    ...
    protected <T> T doWait(int limit, Finder<T> finder) {
        ...
        if (t == null)
            throw new NoSuchElementException("Failed to find '"
                    + finder.toString() + "'");
        return t;
    }
    ...
    public <T extends AbstractPage> T visit(String path, Class<T> serviceClass)
