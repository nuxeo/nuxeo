# Nuxeo platform 5.5.0-HF13 Release Notes

Welcome to the Nuxeo Platform 5.5.0-HF13.
...
The applications based on Nuxeo EP 5.5.0-HF13 need Java. Please install and
set up the recommended [Sun Java Development Kit (JDK) 6][2] if it's not
already installed on your computer.

Nuxeo Platform 5.5.0-HF13 supports OpenJDK 6 as a default Java setup.
