...
public class ITMiscLittleThingsTest extends AbstractTest {
    ...
    public void testPDFExport() {
        ...
        if (JSF_OPTIMS_ENABLED) {
            id = "nxw_documentExport_form:nxw_documentExport_link";
        } else {
            id = "nxw_documentExport_form:nxw_documentActionsUpperButtons_documentExport_subview:nxw_documentActionsUpperButtons_documentExport_link";
        }
        WebElement exportActionPageLink = driver.findElement(By.id(id));
