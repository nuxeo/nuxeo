...
public class ITVerifyDeleteDocumentContentTest extends AbstractTest {
    ...
    @Test
    public void verifyDeleteDocumentContent() throws Exception {
        ...
        assertEquals(1, driver.findElements(By.xpath(
            "//form[@id='document_trash_content_buttons:nxw_CURRENT_SELECTION_DELETE_form']")).size());
        assertEquals(1, driver.findElements(By.xpath(
            "//form[@id='document_trash_content_buttons:nxw_CURRENT_SELECTION_UNDELETE_form']")).size());
