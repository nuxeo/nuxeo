# Nuxeo platform 9.3-SNAPSHOT

Welcome to the Nuxeo Platform 9.3-SNAPSHOT.
...
steps described on the online [Installation Guide][6] or the instructions below:
...
5. Select the addons you want to install on the Platform (a lot of other addons 
   are available and on [the Nuxeo Marketplace][10]).
