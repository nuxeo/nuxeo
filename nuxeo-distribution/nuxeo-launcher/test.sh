...
NUXEO_HOME=${NUXEO_HOME:-$(cd $(dirname $0); cd ../nuxeo-server-tomcat/target/nuxeo-server-10.10-HF41-SNAPSHOT-tomcat; pwd -P)}
...
cp target/nuxeo-launcher-10.10-HF41-SNAPSHOT-jar-with-dependencies.jar "$NUXEO_HOME"/bin/nuxeo-launcher.jar
