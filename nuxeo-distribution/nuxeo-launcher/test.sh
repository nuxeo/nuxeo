...
NUXEO_HOME=${NUXEO_HOME:-$(cd $(dirname $0); cd ../nuxeo-distribution-tomcat/target/nuxeo-cap-7.10-HF23-tomcat; pwd -P)}
...
cp target/nuxeo-launcher-7.10-HF23-jar-with-dependencies.jar "$NUXEO_HOME"/bin/nuxeo-launcher.jar
