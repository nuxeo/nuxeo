...
NUXEO_HOME=${NUXEO_HOME:-$(cd $(dirname $0); cd ../nuxeo-distribution-tomcat/target/nuxeo-dm-5.5-tomcat\ with\ space; pwd -P)}

cp target/nuxeo-launcher-5.5-jar-with-dependencies.jar "$NUXEO_HOME"/bin/nuxeo-launcher.jar
