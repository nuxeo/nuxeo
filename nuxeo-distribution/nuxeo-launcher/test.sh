...
NUXEO_HOME=${NUXEO_HOME:-$(cd $(dirname $0); cd ../nuxeo-server-tomcat/target/nuxeo-server-8.10-HF18-SNAPSHOT-tomcat; pwd -P)}
...
cp target/nuxeo-launcher-8.10-HF18-SNAPSHOT-jar-with-dependencies.jar "$NUXEO_HOME"/bin/nuxeo-launcher.jar
