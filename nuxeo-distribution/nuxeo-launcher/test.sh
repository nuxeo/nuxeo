...
NUXEO_HOME=${NUXEO_HOME:-$(cd $(dirname $0); cd ../nuxeo-distribution-tomcat/target/nuxeo-cap-6.0-HF39-SNAPSHOT-tomcat; pwd -P)}
...
cp target/nuxeo-launcher-6.0-HF39-SNAPSHOT-jar-with-dependencies.jar "$NUXEO_HOME"/bin/nuxeo-launcher.jar
