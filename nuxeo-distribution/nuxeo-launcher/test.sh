...
NUXEO_HOME=${NUXEO_HOME:-$(cd $(dirname $0); cd ../nuxeo-server-tomcat/target/nuxeo-server-9.10-HF03-SNAPSHOT-tomcat; pwd -P)}
...
cp target/nuxeo-launcher-9.10-HF03-SNAPSHOT-jar-with-dependencies.jar "$NUXEO_HOME"/bin/nuxeo-launcher.jar
