...
NUXEO_HOME=${NUXEO_HOME:-$(cd $(dirname $0); cd ../nuxeo-distribution-tomcat/target/nuxeo-cap-8.2-tomcat; pwd -P)}
...
cp target/nuxeo-launcher-8.2-jar-with-dependencies.jar "$NUXEO_HOME"/bin/nuxeo-launcher.jar
