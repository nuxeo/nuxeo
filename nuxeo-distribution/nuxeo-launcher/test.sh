...
NUXEO_HOME=${NUXEO_HOME:-$(cd $(dirname $0); cd ../nuxeo-distribution-tomcat/target/nuxeo-cap-5.6.0-HF06-tomcat; pwd -P)}
...
cp target/nuxeo-launcher-5.6.0-HF06-jar-with-dependencies.jar "$NUXEO_HOME"/bin/nuxeo-launcher.jar
