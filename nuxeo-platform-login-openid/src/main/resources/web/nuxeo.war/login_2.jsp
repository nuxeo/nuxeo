...
.idItem a.openID { background-image: url(<%=context%>/icons/openid.png) }
.idItem a.twitter { background-image: url(<%=context%>/icons/twitter.png) }
.idItem a.linkedIn { background-image: url(<%=context%>/icons/linkedin.png) }
.idItem a.google { background-image: url(<%=context%>/icons/google.png) }
.idItem a.facebook { background-image: url(<%=context%>/icons/facebook.png) }
