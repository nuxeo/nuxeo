...
package org.nuxeo.csv.jsf;

import org.junit.Test;
import org.junit.runner.RunWith;
import org.nuxeo.common.utils.FileUtils;
import org.nuxeo.csv.core.CSVImportLog;
import org.nuxeo.csv.core.CSVImportStatus;
...
@LocalDeploy({ "org.nuxeo.ecm.platform.test:test-usermanagerimpl/userservice-config.xml", //
        "org.nuxeo.csv.core:OSGI-INF/test-directories-contrib.xml", //
        "org.nuxeo.csv.core:OSGI-INF/test-types-contrib.xml", //
        "org.nuxeo.csv.core:OSGI-INF/test-ui-types-contrib.xml" })
