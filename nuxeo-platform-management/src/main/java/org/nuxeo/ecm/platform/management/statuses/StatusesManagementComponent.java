 ...
 */
public class StatusesManagementComponent extends DefaultComponent implements
		ProbeScheduler, ProbeSchedulerMBean, ProbeRunner {
	...
	public StatusesManagementComponent() {
	...
	protected class ManagementPublisher {
		...
		protected void doPublish() {
			service.registerResource("probe-scheduler",
					...
					ProbeSchedulerMBean.class, StatusesManagementComponent.this);
		}
		...
		protected void doQualifyNames(ProbeInfo context,
			...
			context.shortcutName = ObjectNameFactory
					.formatProbeShortName(descriptor.getShortcutName());
			context.qualifiedName = descriptor.getQualifiedName();
			if (context.qualifiedName == null) {
				context.qualifiedName = ObjectNameFactory
						.formatProbeQualifiedName(new ComponentName(descriptor
	...
	public void activate(ComponentContext context) throws Exception {
		managementPublisher.service = (ResourcePublisherService) Framework
				.getLocalService(ResourcePublisher.class);
