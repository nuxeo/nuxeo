...
import org.nuxeo.ecm.automation.server.jaxrs.adapters.ChildrenAdapter;
import org.nuxeo.ecm.automation.server.jaxrs.adapters.PageProviderAdapter;
import org.nuxeo.ecm.automation.server.jaxrs.adapters.SearchAdapter;
...
@Jetty(port = 18090)
@LocalDeploy("org.nuxeo.ecm.automation.test:pageprovider-test-contrib.xml")
