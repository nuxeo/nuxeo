...
public interface Constants {
    ...
    public final static String T_BOOLEAN = "boolean"; // injectable as Boolean
    public final static String T_DATE = "date"; // W3C string injectable as Date
    public final static String T_INTEGER = "integer"; // integer number injectable as Long
    public final static String T_FLOAT = "float"; // float number injectable as Double
    public final static String T_RESOURCE = "resource"; // resource url injectable as URL
    public final static String T_DOCUMENT = "document"; // Document injectable as DocumentRef / DocumentModel
    public final static String T_DOCUMENTS = "documents"; // Document injectable as DocumentRefList / DocumentModelList
    public final static String T_SCRIPT = "script"; // inline mvel injectable script as Script
    public final static String T_PROPERTIES = "properties"; // Java properties content injectable as Properties
    ...
    // Widget types
    public final static String W_TEXT = "Text"; // the default Widget for String or any other unknown type
    public final static String W_MULTILINE_TEXT = "TextArea";
    public final static String W_PROPERTIES = "Properties"; // to edit a properties table
    public final static String W_CHECK = "Check"; // the default widget for Boolean
    public final static String W_RADIO = "Radio";
    public final static String W_OPTION = "Option"; // a single selection listbox
