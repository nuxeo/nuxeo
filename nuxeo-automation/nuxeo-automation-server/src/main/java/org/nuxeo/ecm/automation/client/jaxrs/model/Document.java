...
/**
 * A immutable document. You cannot modify documents.
 * Documents are as they are returned by the server.
 * To modify documents use operations.
 *
 * You need to create your own wrapper if you need to access the document properties in a multi-level way.
 * This is a flat representation of the document.
 *
