 ...
 * @since 7.1
 */
@Operation(id = WriteMetadataToContextFromBinary.ID, category = Constants.CAT_EXECUTION, label = "Write Metadata To Context From Binary", description = "", since = "7.1", addToStudio = true)
