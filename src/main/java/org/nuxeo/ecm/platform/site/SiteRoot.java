...
import org.nuxeo.ecm.platform.site.config.Configuration;
import org.nuxeo.ecm.platform.site.config.MainSection;
import org.nuxeo.ecm.platform.site.config.MappingSection;
