 ...
 * from additional annotations an d using a specific logic.
 * Let say you want a test that launch a nuxeo core with webengine and webdriver enabled.
 ...
 * <p>
 * Features must implements RunnerFeature class
 * 
...
public @interface Features {
    ...
    public Class<? extends RunnerFeature>[] value();
