...
public class MongoDBComponent extends DefaultComponent implements MongoDBConnectionService {
    ...
    public MongoDatabase getDatabase(String id) {
        ...
        MongoDBCountHelper.versions.putIfAbsent(db, fetchVersion(db));
        return db;
    }
    ...
    public static class MongoDBCountHelper {
        ...
        protected static final Map<MongoDatabase, String> versions = new HashMap<>();
        ...
        public static long countDocuments(MongoDatabase database, MongoCollection<Document> collection) {
            return new FileVersion(versions.get(database)).compareTo(
         ...
         */
        @SuppressWarnings("deprecation")
        public static long countDocuments(MongoDatabase database, MongoCollection<Document> collection, Bson filter) {
            return new FileVersion(versions.get(database)).compareTo(
         ...
         */
        @SuppressWarnings("deprecation")
        public static long countDocuments(MongoDatabase database, MongoCollection<Document> collection, Bson filter, CountOptions options) {
            return new FileVersion(versions.get(database)).compareTo(
