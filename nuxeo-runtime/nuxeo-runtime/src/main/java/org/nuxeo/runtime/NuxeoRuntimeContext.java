 ...
 * bundle.
 * <p/>
 * This context is not designed to deploy and undeploy components, it leaves this responsability to
...
public class NuxeoRuntimeContext implements RuntimeContext {
    ...
    public boolean isDeployed(String location) {
        throw new UnsupportedOperationException("Checking if component is deployed with context is no more supported");
    }
    ...
    public void destroy() {
        try {
            ...
            throw new RuntimeServiceException("Unable to close class loader of bundle: " + classLoader.getName());
        }
    }
}
