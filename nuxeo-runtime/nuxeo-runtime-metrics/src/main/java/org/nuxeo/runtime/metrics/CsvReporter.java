/*
 * (C) Copyright 2013 Coda Hale <coda.hale@gmail.com> and others.
 *
 ...
 *
 *
 * This is a patched version of Coda Hale CsvReporter, the sanitizer method is overrided to enable
 * metric name with a '/' in the name.
 *
 * @since 8.3
 */
...
public class CsvReporter extends ScheduledReporter {
    ...
    private static final Log LOGGER = LogFactory.getLog(CsvReporter.class);
