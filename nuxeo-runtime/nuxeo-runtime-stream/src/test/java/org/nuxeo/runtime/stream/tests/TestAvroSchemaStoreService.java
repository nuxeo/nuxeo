...
public class TestAvroSchemaStoreService {
    ...
    public void testSchemaStoreRetrieval() {
        ...
        assertNotNull(Framework.getService(AvroSchemaStoreService.class));
    }

    @Test
    public void testSchemaRetrieval() throws IOException {
        InputStream stream = getClass().getClassLoader().getResourceAsStream("data/avro-schema-example.json");
