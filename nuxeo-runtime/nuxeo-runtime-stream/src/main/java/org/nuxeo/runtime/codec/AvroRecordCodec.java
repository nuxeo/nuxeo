...
/**
 * Use a GenericRecord to represent a Record and its message in a flat AvroMessage
 *
 * @since 11.1
 */
public class AvroRecordCodec<T extends Record> implements Codec<T> {
    ...
    public AvroRecordCodec(Schema messageSchema, String schemaRegistryUrls) {
        ...
        // System.out.println("msg schema: " + this.messageSchema.toString(true));
        // System.out.println("rec + msg schema: " + this.schema.toString(true));
        // register schemas
        try {
    ...
    protected Schema addRecordFieldsToSchema(Schema schema) {
        ...
        fields.add(new Schema.Field(RECORD_KEY, SchemaBuilder.builder().stringType(), "record key", (Object) null));
