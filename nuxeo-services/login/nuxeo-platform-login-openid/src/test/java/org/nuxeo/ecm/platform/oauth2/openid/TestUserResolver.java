...
@Deploy({ "org.nuxeo.ecm.platform.login.openid.test:OSGI-INF/openid-connect-provider-registry.xml",
        "org.nuxeo.ecm.platform.login.openid.test:OSGI-INF/openid-directory-contrib.xml",
        "org.nuxeo.ecm.platform.login.openid.test:OSGI-INF/openid-schema-contrib.xml",
        "org.nuxeo.ecm.platform.login.openid.test:OSGI-INF/openid-userresolver-contrib.xml" })
