...
public class MailSessionBuilder {
    ...
    public static FromBuilder fromNuxeoConf() {
        ...
        Properties properties = frameworkProperties.stringPropertyNames() // no other clean api
                                                   ...
                                                   .collect(Collectors.toMap(Function.identity(),
                                                                             ...
                                                                             Properties::new));
        return fromJndi(Framework.getProperty("jndi.java.mail", "java:comp/env/Mail")).fallbackOn(properties);
    }
    ...
    public static class FromProperties extends AbstractFrom<FromProperties> {
        ...
        private FromProperties(Properties properties) {
            ...
            // remove the debug properties due to javax.mail.Session initialisation which prints to the console
        ...
        public String toString() {
            ...
            Map<Object, Object> propertiesAsMap = properties.entrySet()
                                                            .stream()
                                                            .filter(s -> !s.getKey().toString().contains("password"))
