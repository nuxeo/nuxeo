...
public class ActionService extends DefaultComponent implements ActionManager {
    ...
    private long LOG_MIN_DURATION_NS = Long.parseLong(
    ...
    public void activate(ComponentContext context) {
        ...
        actionsTimer = metrics.timer(MetricRegistry.name("nuxeo", "ActionService", "filter"));
        actionTimer = metrics.timer(MetricRegistry.name("nuxeo", "ActionService", "filter"));
        filtersTimer = metrics.timer(MetricRegistry.name("nuxeo", "ActionService", "filter"));
