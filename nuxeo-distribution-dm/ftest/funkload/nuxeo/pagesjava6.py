...
class FolderPage(BasePage):
    ...
    def createFolder(self, title, description):
        ...
        fl.post(fl.server_url + "/view_documents.faces", params=[
            ...
            ['j_id212_SUBMIT', '1'],
            ['javax.faces.ViewState', fl.getLastJsfState()],
            ['j_id212:j_id218:1:j_id222:0:j_id224:0:j_id228', 'j_id212:j_id218:1:j_id222:0:j_id224:0:j_id228']],
    ...
    def createFile(self, title, description, file_path=None):
        ...
        fl.post(fl.server_url + "/view_documents.faces", params=[
            ...
            ['j_id212_SUBMIT', '1'],
            ['javax.faces.ViewState', fl.getLastJsfState()],
            ['j_id212:j_id218:0:j_id222:0:j_id224:1:j_id228', 'j_id212:j_id218:0:j_id222:0:j_id224:1:j_id228']],
