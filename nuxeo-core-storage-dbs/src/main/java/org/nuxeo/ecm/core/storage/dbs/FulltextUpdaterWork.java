...
import static org.nuxeo.ecm.core.storage.dbs.DBSDocument.SYSPROP_FULLTEXT_BINARY;
import static org.nuxeo.ecm.core.storage.dbs.DBSDocument.SYSPROP_FULLTEXT_JOBID;
import static org.nuxeo.ecm.core.storage.dbs.DBSDocument.SYSPROP_FULLTEXT_SIMPLE;
 ...
 * save time, or through {@link FulltextExtractorWork}) into the fulltext table.
 * <p>
