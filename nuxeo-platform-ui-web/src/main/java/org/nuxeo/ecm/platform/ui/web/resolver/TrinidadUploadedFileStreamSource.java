 ...
 *
 */
public class TrinidadUploadedFileStreamSource extends AbstractStreamSource {

    private final UploadedFile upFile;

    public TrinidadUploadedFileStreamSource(UploadedFile upFile) {
        this.upFile = upFile;
    }
