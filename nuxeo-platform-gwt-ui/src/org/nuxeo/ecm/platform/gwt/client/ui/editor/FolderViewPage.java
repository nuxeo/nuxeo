 ...
 *
 */
public class FolderViewPage extends SmartView<Canvas> implements CellDoubleClickHandler {
...
//        removeButton.setSize(16);
    ...
    public void setInput(Object input) {
        doc = (Document)input;
        getGrid().fetchData(new Criteria("parentId", doc.getId()));/*, new DSCallback() {
