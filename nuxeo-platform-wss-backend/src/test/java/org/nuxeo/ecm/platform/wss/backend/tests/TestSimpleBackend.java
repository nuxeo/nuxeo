...
public class TestSimpleBackend extends SQLRepositoryTestCase {
    ...
    public void setUp() throws Exception {
        ...
        DocumentModel isolatedws = session.createDocumentModel("/default-domain/workspaces/ws1/folder", "isolatedws", "Workspace");
        isolatedws.setPropertyValue("dc:title", "Isolatedws");
        isolatedws = session.createDocument(isolatedws);

        DocumentModel isolatedws2 = session.createDocumentModel("/default-domain/workspaces/ws1/folder", "ws2", "Workspace");
        ...
        DocumentModel doc4 = session.createDocumentModel("/default-domain/workspaces/ws1/folder/isolatedws", "doc4", "File");
    ...
    public void testSimpleBackendBrowse() throws Exception {
        ...
        assertEquals("nuxeo/workspaces/ws1/folder", items.get(0).getRelativeSubPath(""));
        assertEquals("nuxeo/workspaces/ws1/doc1", items.get(1).getSubPath());
        assertEquals("nuxeo/workspaces/ws1/doc1", items.get(1).getRelativeSubPath(""));
        assertEquals("workspaces/ws1/doc1", items.get(1).getRelativeSubPath("nuxeo"));
        assertEquals("workspaces/ws1/document1.doc", items.get(1).getRelativeFilePath("nuxeo"));
    ...
    public void testSearchBackendBrowse() throws Exception {
        ...
        assertEquals("ws1/document1.doc", items.get(1).getRelativeFilePath("nuxeo"));
