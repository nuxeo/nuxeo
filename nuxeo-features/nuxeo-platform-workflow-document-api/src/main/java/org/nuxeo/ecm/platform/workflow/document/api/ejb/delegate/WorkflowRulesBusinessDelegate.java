...
/**
 * Workflow rules business delegate.
 *
 * @author <a href="mailto:ja@nuxeo.com">Julien Anguenot</a>
 */
public class WorkflowRulesBusinessDelegate implements Serializable {
    ...
    public WorkflowRulesManager getWorkflowRules() throws Exception {
        log.debug("getWorkflowRules()");
        if (workflowRules == null) {
            workflowRules = Framework.getService(WorkflowRulesManager.class);
        }
        log.debug("WAPI bean found :" + workflowRules.getClass().toString());
