 ...
 *
 * $Id: WMProcessDefinitionStateImpl.java 21684 2007-06-30 20:59:40Z sfermigier $
 */
...
/**
 * Process definition state implementation.
 *
...
public class WMProcessDefinitionStateImpl implements WMProcessDefinitionState {
    ...
    protected final WMProcessDefinition definition;

    protected final String[] status;

    public WMProcessDefinitionStateImpl(WMProcessDefinition definition,
            String[] status) {
