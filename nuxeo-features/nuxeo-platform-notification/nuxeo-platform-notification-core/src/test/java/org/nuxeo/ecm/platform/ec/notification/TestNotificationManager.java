...
public class TestNotificationManager {
    ...
    public void testSubscribedDocuments() {
        ...
        assertTrue(notificationManager.getSubscribedDocuments(prefixedPrincipalName).isEmpty());
    ...
    public void testSubscriptionOnPublishedDocument() {
        ...
        subscribedDocuments = notificationManager.getSubscribedDocuments(prefixedPrincipalName);
