...
public class DocumentAnnotabilityDescriptor {
    @XNode("@class")
    private Class<? extends DocumentAnnotability> klass;

    public Class<? extends DocumentAnnotability> getKlass() {
        return klass;
    }

    public void setKlass(Class<? extends DocumentAnnotability> klass) {
        this.klass = klass;
    }
}
