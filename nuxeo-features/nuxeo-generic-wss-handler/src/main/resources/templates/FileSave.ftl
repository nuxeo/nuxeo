    ...
    <TR>
        ...
        <TABLE ID="FileDialogViewTable" cellpadding=2 width=100%
            ...
            <TR class="" fileattribute=${item.type}
                ...
                <TD valign="top" class="ms-vb2" width="16">

                <A TABINDEX=-1
                    HREF="${request.getBaseUrl()}?RootFolder=${item.getRelativeFilePath("")}&FolderCTID=&View=FileDialog"
                    >
                <Img width="16" height="16"
                    SRC="icons/${item.icon}" title="icon" alt="icon">
                </A>
