 ...
 * <p/>
 * On 10.10, his feature can be used as it because {@code defaultState} is {@code property}, so using the feature will
 * result in a {@link BridgeCommentManager} having {@link PropertyCommentManager} and {@link TreeCommentManager}.
 * <p/>
 * Use this feature and {@link RelationCommentFeature} to have a {@link BridgeCommentManager} with
 * {@link CommentManagerImpl} and {@link PropertyCommentManager}.
 * 
 * @since 11.1
 */
...
public class BridgeCommentFeature implements RunnerFeature {
    ...
    public void beforeRun(FeaturesRunner runner) {
        ComponentManagerImpl componentManager = (ComponentManagerImpl) Framework.getRuntime().getComponentManager();
    ...
    @Features(BridgeCommentFeature.class)
