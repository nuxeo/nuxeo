...
public abstract class AbstractTestAnnotationNotification {
    ...
    @Before 
    public void before() {
        annotatedDocumentModel = session.createDocument(session.createDocumentModel("/", "test", "File"));
    }
    ...
    protected Annotation createAnnotationAndAddSubscription(String... notifications) {
        ...
        Arrays.stream(notifications)
              .forEach(n -> notificationService.addSubscription(subscriber, n, annotatedDocumentModel, false, principal, n));
