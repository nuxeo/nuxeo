...
public class TestPropertyAnnotationService {
    ...
    public void testGetAnnotation() {
        ...
        try (CloseableCoreSession bobSession = CoreInstance.openCoreSession(docToAnnotate.getRepositoryName(), "bob")) {
            ...
            assertEquals(
                    "The user bob does not have access to the annotations of document " + docToAnnotate.getId(),
                    e.getMessage());
        }
    }
    ...
    public void testUpdateAnnotation() {
        ...
        try (CloseableCoreSession bobSession = CoreInstance.openCoreSession(docToAnnotate.getRepositoryName(), "bob")) {
            ...
            assertEquals("The user bob cannot edit annotations of document " + docToAnnotate.getId(), e.getMessage());
        }
    }
    ...
    public void testDeleteAnnotation() {
        ...
        try (CloseableCoreSession bobSession = CoreInstance.openCoreSession(docToAnnotate.getRepositoryName(), "bob")) {
            ...
            assertEquals("The user bob cannot delete annotations of document " + docToAnnotate.getId(), e.getMessage());
        }
    ...
    public void testGetAnnotationsForDocument() {
        ...
        // Fake the existence of the document for bobSession
        ACPImpl acp = new ACPImpl();
        ACL acl = acp.getOrCreateACL();
