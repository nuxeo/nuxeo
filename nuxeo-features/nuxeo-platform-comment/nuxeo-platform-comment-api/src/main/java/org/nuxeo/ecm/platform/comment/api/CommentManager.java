...
public interface CommentManager {
     ...
     * @since 11.1
     */
    default Comment getExternalComment(CoreSession session, String documentId, String entityId) {
     ...
     * @since 11.1
     */
    default Comment updateExternalComment(CoreSession session, String documentId, String entityId, Comment comment) {
        throw new UnsupportedOperationException();
    }
     ...
     * @since 11.1
     */
    default void deleteExternalComment(CoreSession session, String documentId, String entityId) {
        throw new UnsupportedOperationException();
    }
