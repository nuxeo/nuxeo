...
public abstract class TestESClient {
    ...
    public void testIndexOptimisticConcurrency() {
        ...
        IndexRequest request1 = new IndexRequest("foo-index", "doc_tmp", "123");
        request1.versionType(VersionType.EXTERNAL).version(100);
        request1.source("{\"foo\": \"v1\"}", XContentType.JSON);

        IndexRequest request2 = new IndexRequest("foo-index", "doc_tmp", "123");
        ...
        GetResponse ret = client.get(new GetRequest("foo-index", "doc_tmp", "123"));
