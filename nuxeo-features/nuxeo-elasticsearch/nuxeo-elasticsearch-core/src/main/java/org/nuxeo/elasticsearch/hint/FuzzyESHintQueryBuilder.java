...
/**
 * The implementation of {@link ESHintQueryBuilder} for the <strong>"fuzzy"</strong> Elasticsearch hint operator.
 *
 * @since 11.1
 */
public class FuzzyESHintQueryBuilder implements ESHintQueryBuilder {
     ...
     * <p>
     * 
     * @return {@link org.elasticsearch.index.query.FuzzyQueryBuilder}
     */
    @Override
