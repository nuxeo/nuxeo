...
public class IndexingCommand implements Serializable {
    ...
    public IndexingCommand(DocumentModel document, Type commandType, boolean sync, boolean recurse) {
        ...
        try {
            targetDocument = getValidTargetDocument(document);
        } catch (ClientException e) {
            throw new IllegalArgumentException("Invalid targetDocument: " + document, e);
        }
    ...
    protected DocumentModel getValidTargetDocument(DocumentModel target) throws ClientException {
     ...
     */
    public DocumentModel getTargetDocument() throws ClientException {
