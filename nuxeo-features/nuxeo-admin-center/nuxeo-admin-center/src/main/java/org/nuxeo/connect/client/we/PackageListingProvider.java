...
public class PackageListingProvider extends DefaultObject {
    ...
    public Object getLocal(@QueryParam("type") String type) {
        ...
        return getView("simpleListing").arg("pkgs", pkgs).arg("showCommunityInfo", false).arg("source", "local");
    }
    ...
    public Object getStudio() {
        ...
        return getView("simpleListing").arg("pkgs", pkgsWithoutSnapshot).arg("showCommunityInfo", false).arg("source", "studio");
    }
