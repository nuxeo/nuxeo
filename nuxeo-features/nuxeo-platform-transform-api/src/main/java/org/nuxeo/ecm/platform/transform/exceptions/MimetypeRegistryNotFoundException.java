 ...
 *
 * $Id: MimetypeRegistryNotFoundException.java 16046 2007-04-12 14:34:58Z fguillaume $
 */
...
public class MimetypeRegistryNotFoundException extends Exception {
    ...
    public MimetypeRegistryNotFoundException(String message, Throwable cause) {
        super(message, WrappedException.wrap(cause));
    }

    public MimetypeRegistryNotFoundException(Throwable cause) {
