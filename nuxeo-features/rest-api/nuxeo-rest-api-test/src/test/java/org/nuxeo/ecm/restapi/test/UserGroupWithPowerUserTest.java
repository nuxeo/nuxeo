...
public class UserGroupWithPowerUserTest extends BaseUserTest {
    ...
    public void before() {
        ...
        group.setPropertyValue("group:groupname", "subgroup");
        group.setPropertyValue("group:parentGroups", (Serializable) Collections.singletonList(ADMINISTRATORS_GROUP));
    ...
    public void testPowerUserCannotCreateAdministratorsGroup() throws IOException {
        ...
        ClientResponse response = getResponse(RequestType.POST, "/group", groupJson);
        assertUnauthorizedResponseMessage("Cannot create artifact", response);
    }
    ...
    public void testPowerUserCannotUpdateAdministratorsGroup() throws IOException {
        ...
        ClientResponse response = getResponse(RequestType.PUT, "/group/administrators", groupJson);
        assertUnauthorizedResponseMessage("User is not allowed to edit users", response);
    }

    @Test
    public void testPowerUserCannotDeleteAdministratorsGroup() throws IOException {
        ClientResponse response = getResponse(RequestType.DELETE, "/group/administrators");
        assertUnauthorizedResponseMessage("User is not allowed to edit users", response);
    }
    ...
    public void testPowerUserCannotCreateGroupWithParentAdministratorsGroup() throws IOException {
        ...
        response = getResponse(RequestType.POST, "/group", groupJson);
        assertUnauthorizedResponseMessage("Cannot create artifact", response);
    }
    ...
    public void testPowerUserCannotCreateAdministratorUser() throws IOException {
        ...
        ClientResponse response = getResponse(RequestType.POST, "/user", userJson);
        assertUnauthorizedResponseMessage("Cannot create artifact", response);
    }
    ...
    public void testPowerUserCannotUpdateAdministratorUser() throws IOException {
        ...
        ClientResponse response = getResponse(RequestType.PUT, "/user/Administrator", userJson);
        assertUnauthorizedResponseMessage("User is not allowed to edit users", response);
    }
    ...
    public void testPowerUserCannotPromoteUserAsAdministrator() throws IOException {
        ...
        ClientResponse response = getResponse(RequestType.PUT, "/user/fry", userJson);
        assertUnauthorizedResponseMessage("User is not allowed to edit users", response);
        ...
        response = getResponse(RequestType.PUT, "/user/fry", userJson);
        assertUnauthorizedResponseMessage("User is not allowed to edit users", response);
    }
    ...
    public void testPowerUserCannotPromoteHimselfAsAdministrator() throws IOException {
        ...
        ClientResponse response = getResponse(RequestType.PUT, "/user/leela", userJson);
        assertUnauthorizedResponseMessage("User is not allowed to edit users", response);
    }

    @Test
    public void testPowerUserCannotAddAdministratorsGroup() throws IOException {
        ClientResponse response = getResponse(RequestType.POST, "/user/fry/group/administrators");
        assertUnauthorizedResponseMessage("Cannot edit user", response);
    }

    @Test
    public void testPowerUserCannotRemoveAdministratorsGroup() throws IOException {
        ClientResponse response = getResponse(RequestType.DELETE, "/user/Administrator/group/administrators");
        assertUnauthorizedResponseMessage("Cannot edit user", response);
    }

    @Test
    public void testPowerUserCannotAddUserToAdministratorsGroup() throws IOException {
        ClientResponse response = getResponse(RequestType.POST, "/group/administrators/user/fry");
        assertUnauthorizedResponseMessage("Cannot edit user", response);
    }

    @Test
    public void testPowerUserCannotRemoveUserFromAdministratorsGroup() throws IOException {
        ClientResponse response = getResponse(RequestType.DELETE, "/group/administrators/user/Administrator");
        assertUnauthorizedResponseMessage("Cannot edit user", response);
    }

    protected void assertUnauthorizedResponseMessage(String expectedMessage, ClientResponse response) throws IOException {
