...
public class Dashboard implements Serializable {
  ...
  public List<String> getCategories() {
    ...
    try {
      ...
      for (String s : factoryManager.getContainerFactory()
          .getGadgetList()
          .keySet()) {
        result.add(s);
      }
  ...
  public List<Map<String, String>> getGadgets() {
    ...
    try {
      ...
      Map<String, ArrayList<String>> gadgetList = factoryManager.getContainerFactory()
          .getGadgetList();
  ...
  public void dumpDocumentInfo(String docId) {
    try {
      ...
      log.info("document type:" + model.getDocumentType()
          .getName());
      log.info("document path:" + model.getPathAsString());
      String[] schemaNames = model.getDocumentType()
          .getSchemaNames();
        ...
        for (String propName : propMap.keySet()) {
          if (propMap.get(propName) == null) {
            ...
            if (propMap.get(propName) instanceof GregorianCalendar) {
              ...
              log.info("" + propName + " ---> " + calendar.getTimeInMillis());
            } else {
