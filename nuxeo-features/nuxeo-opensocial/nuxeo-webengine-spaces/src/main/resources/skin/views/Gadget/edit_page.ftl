...
<#else>
<h2><a href="${This.previous.path}"><img src="${skinPath}/image/up_nav.gif" alt="Up" border="0"/></a> ${This.gadget.title}</h2>
</#if>
...
<table class="formFill">
    <tbody>
        <tr>
            <td>Name:</td>
            <td><input type="text" name="name" readonly="readonly" value="${This.gadget.name}" size="40"></td>
        </tr>
        <tr>
            <td>Title:</td>
            <td><input type="text" name="dc:title" value="${This.gadget.title}" size="40"/></td>
        </tr>
        <tr>
            <td colspan="2">Description</td>
        </tr>
        <tr>
            <td colspan="2"><textarea name="dc:description" cols="54">${This.gadget.description}</textarea></td>
        </tr>
