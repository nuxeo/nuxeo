...
public class GadgetService {
    ...
    public static void setHeight(String ref, int height) {
        ...
        portal.getGadgetPortlet(ref).setHeight(height + 20);
    ...
    public static void saveUserPref(String ref) {
        ...
        GadgetBean bean = ContainerEntryPoint.getContainerPortal().getGadgetPortlet(
                ref).getGadgetBean();
    ...
    public static void setUserPref(String ref, String key, String value) {
        ContainerEntryPoint.getContainerPortal().getGadgetPortlet(ref).getGadgetBean().setPref(
                key, value);
    };
    ...
    public static void setTitleToGadget(String ref, String title) {
        ContainerEntryPoint.getContainerPortal().getGadgetPortlet(ref).setTitle(
                title);
    };
