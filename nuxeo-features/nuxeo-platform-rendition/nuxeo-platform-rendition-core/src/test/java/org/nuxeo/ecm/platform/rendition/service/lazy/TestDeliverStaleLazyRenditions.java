...
public class TestDeliverStaleLazyRenditions {
    ...
    // NXP-27316
    @Test
    public void testOnlyStoreUpToDateRenditions() throws IOException {
    ...
    /**
     * Updates the test document, asks for a "lazyAutomation" rendition (expecting it to be stale) and waits for
