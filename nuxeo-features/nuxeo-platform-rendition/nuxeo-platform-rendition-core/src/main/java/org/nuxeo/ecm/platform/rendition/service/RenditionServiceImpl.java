...
public class RenditionServiceImpl extends DefaultComponent implements RenditionService {
     ...
     * @since 8.1
     */
    protected StoredRenditionManager storedRenditionManager = new DefaultStoredRenditionManager();

    /**
     * @since 8.1
     */
    public StoredRenditionManager getStoredRenditionManager() {
        return storedRenditionManager;
    }
    ...
    protected StoredRendition storeRendition(DocumentModel sourceDocument, Rendition rendition) {
        ...
        StoredRendition storedRendition = storedRenditionManager.createStoredRendition(sourceDocument, version,
    ...
    public void registerContribution(Object contribution, String extensionPoint, ComponentInstance contributor) {
        if (RENDITION_DEFINITIONS_EP.equals(extensionPoint)) {
            ...
            storedRenditionManager = ((StoredRenditionManagerDescriptor) contribution).newStoredRenditionManager();
        }
    }
    ...
    public void unregisterContribution(Object contribution, String extensionPoint, ComponentInstance contributor) {
        if (RENDITION_DEFINITIONS_EP.equals(extensionPoint)) {
            ...
            storedRenditionManager = new DefaultStoredRenditionManager();
        }
    }
