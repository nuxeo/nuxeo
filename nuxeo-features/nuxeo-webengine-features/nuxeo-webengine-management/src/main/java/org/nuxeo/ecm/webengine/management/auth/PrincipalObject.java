...
package org.nuxeo.ecm.webengine.management.auth;
 ...
 */
@WebObject(type = "Principal")
public class PrincipalObject extends DefaultObject {

    private static final Log log = LogFactory.getLog(UserManager.class);

    protected UserManager userManager;

    public static PrincipalObject newObject(DefaultObject from) {
        return (PrincipalObject)from.newObject("Principal");
    }
