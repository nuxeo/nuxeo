...
<body>
  ...
  <applet id="nxshell" width="800" height="600" archive="${Root.URL}/shell.jar" code="org.nuxeo.ecm.shell.swing.ShellApplet">
  ...
  <script> 
    var attributes = {archive:'${Root.URL}/shell.jar', code:'org.nuxeo.ecm.shell.swing.ShellApplet', width:800, height:600} ; 
