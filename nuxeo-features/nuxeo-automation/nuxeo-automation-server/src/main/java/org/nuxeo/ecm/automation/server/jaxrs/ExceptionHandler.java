...
public class ExceptionHandler {
    ...
    public static WebApplicationException newException(String message, Throwable cause) {
        ...
        return new WebApplicationException(cause, Response.status(e.getStatus()).entity(e).build());
    }
    ...
    public static int getStatus(Throwable cause) {
        ...
        if (cause instanceof DocumentSecurityException
            ...
            if (ccause != null && ccause.getMessage() != null) {
                if (ccause.getMessage().contains("org.nuxeo.ecm.core.model.NoSuchDocumentException")) {
                    status = 404;
                }
            }
