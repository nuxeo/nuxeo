...
public class TestResponseHelper {
    ...
    public void shouldGetBlobResponseWithHeaders() {
        Blob blob = new StringBlob("my doc content", "text/html", "ISO-8859-1");
        ...
        Blob blob2 = new StringBlob("my doc 2 content");
        Response response2 = ResponseHelper.blob(blob2);
        assertEquals("text/plain; charset=UTF-8", response2.getMetadata().get("Content-Type").get(0).toString());
    }
