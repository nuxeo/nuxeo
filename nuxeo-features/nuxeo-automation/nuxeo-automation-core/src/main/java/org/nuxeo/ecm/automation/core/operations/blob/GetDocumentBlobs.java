 ...
 *
 */
@Operation(id=GetDocumentBlobs.ID, category=Constants.CAT_BLOB, label="Get Document Files",
...
public class GetDocumentBlobs {
    ...
    @Param(name="xpath", required=false, values="files:files") protected String xpath="files:files";
