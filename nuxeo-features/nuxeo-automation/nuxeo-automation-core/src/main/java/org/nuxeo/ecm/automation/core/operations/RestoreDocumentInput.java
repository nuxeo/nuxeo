 ...
 *
 */
@Operation(id=RestoreDocumentInput.ID, category=Constants.CAT_EXECUTION, label="Restore Document Input",
...
public class RestoreDocumentInput {
    ...
    public DocumentModel run() throws Exception {
        ...
        throw new OperationException("Illegal state error for restore document operation. The context map doesn't contains a document variable with name "+name);
    }
