...
public interface AutomationService {
     ...
     *
     * @deprecated no chain registry existence since chain. became an operation - use #putOperation method instead.
     * @since 5.7.2
     */
    @Deprecated
     ...
     *
     * @deprecated no chain registry existence since chain. became an operation - use #removeOperation method instead.
     * @since 5.7.2
     */
    @Deprecated
