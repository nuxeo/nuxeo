 ...
 *
 */
@Operation(id=RestoreDocumentsInput.ID, category=Constants.CAT_EXECUTION, label="Restore Documents Input",
...
public class RestoreDocumentsInput {
    ...
    public DocumentModelList run() throws Exception {
        ...
        throw new OperationException("Illegal state error for restore documents operation. The context stack doesn't contains a documents variable with the name "+name);
    }
