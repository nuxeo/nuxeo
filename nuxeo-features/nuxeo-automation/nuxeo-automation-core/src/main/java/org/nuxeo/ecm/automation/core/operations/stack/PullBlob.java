 ...
 *
 */
@Operation(id=PullBlob.ID, category=Constants.CAT_EXECUTION_STACK, label="Pull File",
...
public class PullBlob {
    ...
    public final static String ID = "Blob.Pull";
    ...
    public Blob run() throws Exception {
        ...
        throw new OperationException("Illegal state error for pull file operation. The context stack doesn't contains a file on its bottom");
    }
