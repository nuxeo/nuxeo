...
@Deploy({ "org.nuxeo.ecm.platform.usermanager.api", "org.nuxeo.ecm.platform.usermanager",
        ...
        "org.nuxeo.ecm.automation.features:test-user-directories-contrib.xml" })
public class TestSuggestUserEntries {
    ...
    @Test
    @Deploy("org.nuxeo.ecm.automation.features:test-user-suggestion-fullname-disabled-contrib.xml")
    public void testUserFullnameSearchDisabled() throws Exception {
        try (OperationContext ctx = new OperationContext(session)) {
