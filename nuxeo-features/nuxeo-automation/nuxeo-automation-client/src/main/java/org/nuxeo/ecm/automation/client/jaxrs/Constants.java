...
public class Constants {
    ...
    public static final String CTYPE_MULTIPART_RELATED = "multipart/related"; // for blobs upload
    public static final String CTYPE_MULTIPART_MIXED = "multipart/mixed"; // for blobs download
     ...
     * <p>
     * If the header is not specified, the default properties are returned
     * (the minimal document properties).
     ...
     * It must be <code>true</code> or <code>false</code>.
     ...
     * <p>
     * For example the operation <code>Blob.Attach</code> returns back the attached blob.
     * This may generate a lot of network traffic that is not needed by the client
     * (sending back the same blob as the one sent by the client as the operation input).
