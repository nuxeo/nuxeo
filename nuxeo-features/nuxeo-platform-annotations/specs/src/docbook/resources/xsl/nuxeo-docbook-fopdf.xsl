...
<!--
    This is the XSL FO (PDF) stylesheet for the Nuxeo Reference
    Documentation.
                ...
                <fo:table-body>
                    <fo:table-row>
                        <fo:table-cell text-align="center">
                            <fo:block>
                                <fo:external-graphic src="./src/docbook/resources/images/nuxeo_banner_logo.jpg"/>
                            </fo:block>
                    ...
                    <fo:table-row>
                        <fo:table-cell text-align="center">
                            <fo:block font-family="Helvetica" font-size="12pt" padding-before="90mm">
                                <xsl:text>Copyright &copyright; 2000-2007, Nuxeo SAS. </xsl:text>
	...
	<xsl:template name="footer.content">
		...
		<xsl:variable name="Version">
			<xsl:if test="//releaseinfo">
				<xsl:text>Nuxeo EP </xsl:text><xsl:value-of select="//releaseinfo" /><xsl:text></xsl:text>
			</xsl:if>
		</xsl:variable>
		<xsl:choose>
