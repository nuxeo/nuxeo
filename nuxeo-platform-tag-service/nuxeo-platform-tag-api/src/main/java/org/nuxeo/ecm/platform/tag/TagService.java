...
public interface TagService {
    ...
    /**
     * Optional way to initialize the service. It is used to connect to a DB by
     * request. The expected properties are hibernation kind. Please check the
     ...
     * repository. The current functionality is to keep all tags inside
    ...
    /**
     * Lists all tags in the specified tag group. Tags are saved in a tree structure, any
    ...
    /**
     * Lists tags applied on a document. The private tags or tagging are not
     ...
     * @throws ClientException
     */
    DocumentModel getOrCreateTag(DocumentModel parent, String label, boolean privateFlag)
        throws ClientException;
    /**
     * Retrieves the "vote" weight of tag. More about Vote Tag Cloud 
     * {@link WeightedTag}. The private taggings are not selected, but the 
    ...
    /**
     * Retrieves the "popular" weight of tag. More about Vote Tag Cloud 
     * {@link WeightedTag}. The private tagging are not selected, but the 
     * ones owned by the current principal.
    ...
    /**
     * Retrieves the "popular" tag cloud. More about Popular Tag Cloud 
     * {@link WeightedTag}. The private tags or tagging are not selected, but the 
     * ones owned by the current principal.
     * @param document
     * @return
    ...
    /**
     * Tags a document. It only creates the tagging entry, if not already a
     ...
     * @throws ClientException
     */
    void tagDocument(DocumentModel document, String tagId, boolean privateFlag) 
        throws ClientException;
    /**
