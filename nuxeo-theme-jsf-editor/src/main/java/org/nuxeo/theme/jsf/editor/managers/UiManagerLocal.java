...
import org.nuxeo.theme.jsf.editor.managers.UiManager.FieldProperty;
import org.nuxeo.theme.jsf.editor.managers.UiManager.FragmentInfo;
import org.nuxeo.theme.jsf.editor.managers.UiManager.PaddingInfo;
import org.nuxeo.theme.jsf.editor.managers.UiManager.PageInfo;
import org.nuxeo.theme.jsf.editor.managers.UiManager.PresetInfo;
import org.nuxeo.theme.jsf.editor.managers.UiManager.StyleCategory;
import org.nuxeo.theme.jsf.editor.managers.UiManager.StyleFieldProperty;
import org.nuxeo.theme.jsf.editor.managers.UiManager.StyleLayer;
import org.nuxeo.theme.jsf.editor.managers.UiManager.ThemeInfo;
