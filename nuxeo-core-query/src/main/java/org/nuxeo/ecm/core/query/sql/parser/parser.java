...
public class parser extends java_cup.runtime.lr_parser {
    ...
    public void parseFailed(String message, Symbol token)
            throws QueryParseException {
        done_parsing();
        if (token != null) {
            StringBuffer buf = new StringBuffer(message);
            message = buf.append(": Invalid token <").append(token.value).append(
                    "> at offset ").append(token.right).toString();
        }
...
class CUP$parser$actions {
    ...
    public final java_cup.runtime.Symbol CUP$parser$do_action(
        ...
        case 55: // predicate ::= reference STARTSWITH STRING
        {
            ...
            RESULT = new Predicate(ref, Operator.STARTSWITH, new StringLiteral(
                    s));
            CUP$parser$result = new java_cup.runtime.Symbol(
                    8/* predicate */,
                    ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top - 2)).left,
        ...
        case 4: // query ::= select_clause from_clause order_by_clause
        {
            ...
            /* . . . . . . . . . . . . . . . . . . . . */
        case 3: // query ::= select_clause from_clause where_clause
                // order_by_clause
        {
            SQLQuery RESULT = null;
