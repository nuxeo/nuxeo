 ...
 * 
 */
public class PublishingDocumentModelTreeImpl extends
        ArrayList<DocumentModelTreeNode> implements DocumentModelTree {

    private static final long serialVersionUID = -6980985131163070762L;

    protected Map<String, String> pathTitles;

    public PublishingDocumentModelTreeImpl() {
    ...
    public void add(DocumentModel document, int level) {
        PublishingDocumentTreeModelNodeImpl node = new PublishingDocumentTreeModelNodeImpl(
                document, level);
        add(node);
