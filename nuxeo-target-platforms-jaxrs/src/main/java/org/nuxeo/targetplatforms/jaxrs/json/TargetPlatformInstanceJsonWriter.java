...
public class TargetPlatformInstanceJsonWriter implements
        MessageBodyWriter<TargetPlatformInstance> {
    ...
    @Override
    public long getSize(TargetPlatformInstance t, Class<?> type,
            Type genericType, Annotation[] annotations, MediaType mediaType) {
        return -1;
    }

    @Override
    public void writeTo(TargetPlatformInstance t, Class<?> type,
            Type genericType, Annotation[] annotations, MediaType mediaType,
