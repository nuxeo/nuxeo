...
public class TargetPlatformsInfoJsonWriter implements
        MessageBodyWriter<TargetPlatformsInfo> {
    ...
    @Override
    public long getSize(TargetPlatformsInfo t, Class<?> type, Type genericType,
            Annotation[] annotations, MediaType mediaType) {
        return -1;
    }

    @Override
    public void writeTo(TargetPlatformsInfo t, Class<?> type, Type genericType,
            Annotation[] annotations, MediaType mediaType,
            MultivaluedMap<String, Object> httpHeaders,
            OutputStream entityStream) throws IOException,
            WebApplicationException {
        boolean pretty = Boolean.parseBoolean(request.getParameter("pretty"));
        JSONExporter.exportInfosToJson(t, entityStream, pretty);
    }
