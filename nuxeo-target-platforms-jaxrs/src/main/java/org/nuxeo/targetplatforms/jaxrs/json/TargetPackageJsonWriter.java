...
public class TargetPackageJsonWriter implements
        MessageBodyWriter<TargetPackage> {
    ...
    @Override
    public long getSize(TargetPackage t, Class<?> type, Type genericType,
            Annotation[] annotations, MediaType mediaType) {
        return -1;
    }

    @Override
    public void writeTo(TargetPackage t, Class<?> type, Type genericType,
            Annotation[] annotations, MediaType mediaType,
