...
public class TargetPackageInfoJsonWriter implements
        MessageBodyWriter<TargetPackageInfo> {
    ...
    @Override
    public long getSize(TargetPackageInfo t, Class<?> type, Type genericType,
            Annotation[] annotations, MediaType mediaType) {
        return -1;
    }

    @Override
    public void writeTo(TargetPackageInfo t, Class<?> type, Type genericType,
            Annotation[] annotations, MediaType mediaType,
