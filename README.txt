...
Meaning "mvn clean install" produces:
  ...
  * Nuxeo EP resource files (for various backends or deployments) for EAR
    nuxeo-platform-ear/target/nuxeo-platform-ear-5.3.2-HF08-*.zip
  * Nuxeo DM EAR with default VCS backend 
    nuxeo-distribution-dm/target/nuxeo-distribution-dm-5.3.2-HF08.zip
  * JBoss 4.2.3.GA containing Nuxeo DM with default VCS backend
    nuxeo-distribution-jboss/target/nuxeo-distribution-jboss-5.3.2-HF08-nuxeo-dm.zip
...
for the package ("artifact") named "nuxeo-distribution-tomcat":
  * nuxeo-distribution-tomcat-5.3.2-HF08-nuxeo-dm-jtajca.zip
  * nuxeo-distribution-tomcat-5.3.2-HF08-nuxeo-dm.zip
...
Default profiles are within asterisks: *foo*
  ...
  * Module nuxeo-platform-ear
    o Produced artifacts
      nuxeo-platform-ear-5.3.2-HF08.pom
      nuxeo-platform-ear-5.3.2-HF08.zip
      (DEPRECATED) nuxeo-platform-ear-5.3.2-HF08-resources-common.zip
      (DEPRECATED) nuxeo-platform-ear-5.3.2-HF08-resources-derby.zip
      (DEPRECATED) nuxeo-platform-ear-5.3.2-HF08-resources-h2.zip
      (DEPRECATED) nuxeo-platform-ear-5.3.2-HF08-resources-jcr-postgresql.zip
      (DEPRECATED) nuxeo-platform-ear-5.3.2-HF08-resources-jcr.zip
      (DEPRECATED) nuxeo-platform-ear-5.3.2-HF08-resources-mono.zip
      (DEPRECATED) nuxeo-platform-ear-5.3.2-HF08-resources-mysql.zip
      (DEPRECATED) nuxeo-platform-ear-5.3.2-HF08-resources-oracle.zip
      (DEPRECATED) nuxeo-platform-ear-5.3.2-HF08-resources-platform-stateful.zip
      (DEPRECATED) nuxeo-platform-ear-5.3.2-HF08-resources-postgresql.zip
      (DEPRECATED) nuxeo-platform-ear-5.3.2-HF08-resources-web-stateless.zip
  ...
  * Module nuxeo-distribution-dm
    o Produced artifacts
      nuxeo-distribution-dm-5.3.2-HF08.pom
      nuxeo-distribution-dm-5.3.2-HF08.zip
      (COMPLIANCE) nuxeo-distribution-dm-5.3.2-HF08-resources.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-resources.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-jcr-postgresql.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-jcr.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-platform-stateful-derby.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-platform-stateful-h2.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-platform-stateful-mysql.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-platform-stateful-oracle.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-platform-stateful-postgresql.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-platform-stateful-resources-derby.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-platform-stateful-resources-h2.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-platform-stateful-resources-mysql.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-platform-stateful-resources-oracle.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-platform-stateful-resources-postgresql.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-platform-stateful-resources.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-platform-stateful.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-resources-derby.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-resources-h2.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-resources-jcr-postgresql.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-resources-jcr.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-resources-mysql.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-resources-oracle.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-resources-postgresql.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-web-stateless-resources.zip
      (DEPRECATED) nuxeo-distribution-dm-5.3.2-HF08-web-stateless.zip
    o Available profiles
      all-distributions
      all
  ...
  * Module nuxeo-distribution-jboss
    o Produced artifacts
      nuxeo-distribution-jboss-5.3.2-HF08-nuxeo-ep.zip
      nuxeo-distribution-jboss-5.3.2-HF08-nuxeo-dm.zip
    o Available profiles
      all-distributions
      all
      nuxeo-ep
  ...
  * Module nuxeo-distribution-shell
    o Produced artifacts
      nuxeo-distribution-shell-5.3.2-HF08.zip
    o No available profile
    
  * Module nuxeo-distribution-jetty*
    o Produced artifacts
      nuxeo-distribution-jetty-5.3.2-HF08-nuxeo-dm.zip
      nuxeo-distribution-jetty-5.3.2-HF08-nuxeo-ep.zip
    o Available profiles
      all-distributions
      all
      *nuxeo-dm*
  ...
  * Module nuxeo-distribution-tomcat
    o Produced artifacts
      nuxeo-distribution-tomcat-5.3.2-HF08-nuxeo-dm.zip
      nuxeo-distribution-tomcat-5.3.2-HF08-coreserver.zip
    o No available profile
  ...
  * Module nuxeo-distribution-resources
    o Produced artifacts
      nuxeo-distribution-resources-5.3.2-HF08-bin.zip
      nuxeo-distribution-resources-5.3.2-HF08-doc.zip
      nuxeo-distribution-resources-5.3.2-HF08-jetty-base.zip
      nuxeo-distribution-resources-5.3.2-HF08-templates-jboss-dm.zip
      nuxeo-distribution-resources-5.3.2-HF08-templates-jboss.zip
      nuxeo-distribution-resources-5.3.2-HF08-templates-tomcat.zip
    o No available profile
...
see nuxeo-distribution-dm-5.3.2-HF08-jcr-postgresql.zip
