...
@Deploy("org.nuxeo.ecm.liveconnect.core")
...
@Deploy("org.nuxeo.ecm.liveconnect.core:OSGI-INF/test-core-cache-config.xml")
@Deploy("org.nuxeo.ecm.liveconnect.core:OSGI-INF/test-core-config.xml")
@Deploy("org.nuxeo.ecm.liveconnect.core:OSGI-INF/test-core-pageprovider-contrib.xml")
