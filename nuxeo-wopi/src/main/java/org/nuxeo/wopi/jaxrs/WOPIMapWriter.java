...
/**
 * Writer writing a {@link WOPIMap} object.
 *
 * @since 10.3
 */
@Provider
@Produces(MediaType.APPLICATION_JSON)
public class WOPIMapWriter implements MessageBodyWriter<WOPIMap> {
    ...
    public boolean isWriteable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
        return WOPIMap.class.isAssignableFrom(type);
    }

    @Override
    public long getSize(WOPIMap wopiMap, Class<?> type, Type genericType, Annotation[] annotations,
            MediaType mediaType) {
        return -1;
    }
