...
public class RepositorySessionLockStressTestCase extends RepositoryOSGITestCase {

    public static final String PREFIX = RepositorySessionLockStressTestCase.class.getSimpleName();
    ...
    protected RepositorySessionLockStressTestCase(int numberOfDocuments,
    ...
    protected static Log log = LogFactory.getLog(RepositorySessionLockStressTestCase.class);
    ...
    public class OperationRunner implements Runnable {
        ...
        protected void acquireSession() {
            if (!isThreadSafe) {
                session = RepositorySessionLockStressTestCase.this.coreSession;
            } else {
    ...
    protected void startRunners() throws InterruptedException {
        ...
        ThreadGroup group = new ThreadGroup(
                RepositorySessionLockStressTestCase.class.getSimpleName());
    ...
    public static void main(String[] args) {
        ...
        TestCase test = new RepositorySessionLockStressTestCase(documentCount,
