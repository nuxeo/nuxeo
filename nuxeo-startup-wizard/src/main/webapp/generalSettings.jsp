...
<%@ include file="includes/form-start.jsp" %>
  ...
  <table>
    <tr>
      ...
      <td><input type="text" name="nuxeo.bind.address" value="<%=collector.getConfigurationParam("nuxeo.bind.address") %>"/></td>
    ...
    <tr>
      ...
      <td><input type="text" name="nuxeo.log.dir" value="<%=collector.getConfigurationParam("nuxeo.log.dir") %>"/></td>
      <td class="helpCell"><fmt:message key="label.nuxeo.log.dir.help"/></td>
    </tr>
    <tr>
      <td class="labelCell"><fmt:message key="label.nuxeo.data.dir"/></td>
      <td><input type="text" name="nuxeo.data.dir" value="<%=collector.getConfigurationParam("nuxeo.data.dir") %>"/></td>
