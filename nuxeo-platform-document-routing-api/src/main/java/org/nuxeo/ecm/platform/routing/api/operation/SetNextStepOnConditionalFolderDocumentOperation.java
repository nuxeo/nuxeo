 ...
 * @since 5.4.3
 */
@Operation(id = SetNextStepOnConditionalFolderDocumentOperation.ID, category = DocumentRoutingConstants.OPERATION_CATEGORY_ROUTING_NAME, label = "Choose branch", description = "Update branch to be executed ")
public class SetNextStepOnConditionalFolderDocumentOperation {
    ...
    public void setStepToBeExcutedNext(String nextStepPos) {
