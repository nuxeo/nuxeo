...
import org.nuxeo.ecm.platform.webengine.jsf.wiki.StaticLocator;
...
public class WikiPreviewBean {
    ...
    public String getSimpleWikiPagePreview() throws IOException, WikiParserException
    {
    ...
    protected String getRenderPreview(DocumentModel wikiPage) throws RenderingException
    {
        initEngine();
    ...
    protected String getSimplePreview(DocumentModel wikiPage) throws IOException, WikiParserException
    {
