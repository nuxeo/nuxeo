...
public class TestZipImporter extends RepositoryOSGITestCase {
    ...
    public void testImportZipWithDirectory() throws Exception {
        ...
        DocumentModel directory = coreSession.getChild(doc.getRef(), "test");
        assertNotNull(directory);
        assertEquals("Folder", directory.getType());
        DocumentModel child = coreSession.getChild(directory.getRef(), "test.txt");
        assertNotNull(child);
        assertEquals("text", child.getType());
    }
