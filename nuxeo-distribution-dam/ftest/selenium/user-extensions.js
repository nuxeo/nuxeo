...
Selenium.prototype.doRetrieveTestFolderPath = function() {
  storedVars['testfolderpath'] = "/Users/troger/code/nuxeo/nuxeo-dam/nuxeo-dam-distribution/ftest/selenium";
};
...
// works for jquery and prototype calls
Selenium.prototype.doWaitForQueries = function(timeout) {
  return Selenium.decorateFunctionWithTimeout(function() {
  	var testWindow = selenium.browserbot.getCurrentWindow();
    if (testWindow.wrappedJSObject) {
        testWindow = testWindow.wrappedJSObject;
