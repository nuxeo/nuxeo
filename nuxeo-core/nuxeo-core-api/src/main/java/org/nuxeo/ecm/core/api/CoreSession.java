...
public interface CoreSession extends AutoCloseable {
     ...
     * @deprecated Since 7.10-HF04, 8.2. Use {@link #copy(DocumentRef, DocumentRef, String, CopyOption...)} instead
     */
    @Deprecated
     ...
     * @deprecated Since 7.10-HF04, 8.2. Use {@link #copy(List, DocumentRef, CopyOption...)}
     */
    @Deprecated
     ...
     * @return
     * @since 5.7
     * @deprecated Since 7.10-HF04, 8.2. Use {@link #copy(List, DocumentRef, CopyOption...)} instead
     */
    @Deprecated
     ...
     * @param dst the destination folder reference
     * @param name the new name of the file or null if the original name must be preserved
     * @deprecated Since 7.10-HF04, 8.2. Use
     *             {@link #copyProxyAsDocument(DocumentRef, DocumentRef, String, CopyOption...)} instead
     */
    @Deprecated
     ...
     * @param src the documents to copy
     * @param dst the destination folder
     * @deprecated Since 7.10-HF04, 8.2. Use {@link #copyProxyAsDocument(List, DocumentRef, CopyOption...)} instead
     */
    @Deprecated
