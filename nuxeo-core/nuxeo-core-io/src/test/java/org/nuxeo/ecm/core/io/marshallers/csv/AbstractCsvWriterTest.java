...
public abstract class AbstractCsvWriterTest<WriterClass extends Writer<MarshalledType>, MarshalledType> {
    ...
    public static abstract class Local<WriterClass extends Writer<MarshalledType>, MarshalledType> extends
            AbstractCsvWriterTest<WriterClass, MarshalledType> {
    ...
    public String asCsv(MarshalledType object) throws IOException {
        ...
        getInstance().write(object, marshalledClass, marshalledGenericType, MediaType.valueOf("text/csv"), baos);
        return baos.toString();
    }

    public String asCsv(MarshalledType object, RenderingContext ctx) throws IOException {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        getInstance(ctx).write(object, marshalledClass, marshalledGenericType, MediaType.valueOf("text/csv"), baos);
        return baos.toString();
    }
