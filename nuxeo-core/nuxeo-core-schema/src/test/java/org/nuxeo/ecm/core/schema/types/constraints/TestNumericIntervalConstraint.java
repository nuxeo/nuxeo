...
public class TestNumericIntervalConstraint {
    ...
    private NumericIntervalConstraint minInMaxEx = new NumericIntervalConstraint(
            VAL2, true, VAL4, false);

    private NumericIntervalConstraint minIn = new NumericIntervalConstraint(
            VAL2, true, null, false);
