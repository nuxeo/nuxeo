...
public class TestDateIntervalConstraint {
    ...
    private DateIntervalConstraint minInMaxEx = new DateIntervalConstraint(
            NOV2, true, NOV4, false);

    private DateIntervalConstraint minIn = new DateIntervalConstraint(NOV2,
            true, null, false);
