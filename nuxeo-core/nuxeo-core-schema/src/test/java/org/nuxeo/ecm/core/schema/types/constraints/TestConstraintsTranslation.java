...
public class TestConstraintsTranslation {
    ...
    public void testNumericIntervalContraintMinExMaxExMessage() {
        checkConstraintMessage(new NumericIntervalConstraint(2, false, 10,
                false));
    }

    @Test
    public void testNumericIntervalContraintMinInMessage() {
        checkConstraintMessage(new NumericIntervalConstraint(2, true, null,
                true));
    }

    @Test
    public void testNumericIntervalContraintMinExMessage() {
        checkConstraintMessage(new NumericIntervalConstraint(2, false, null,
                true));
    }

    @Test
    public void testNumericIntervalContraintMaxInMessage() {
        checkConstraintMessage(new NumericIntervalConstraint(null, true, 10,
                true));
    }
    ...
    public void testDateIntervalContraintMinInMaxInMessage() {
        checkConstraintMessage(new DateIntervalConstraint("2014-11-02", true,
                "2014-11-10", true));
    }
    ...
    public void testDateIntervalContraintMinExMaxInMessage() {
        checkConstraintMessage(new DateIntervalConstraint("2014-11-02", false,
                "2014-11-10", true));
    }
    ...
    public void testDateIntervalContraintMaxInMessage() {
        checkConstraintMessage(new DateIntervalConstraint(null, true,
                "2014-11-10", true));
    }
    ...
    private void checkConstraintMessage(Constraint constraint) {
        for (Locale locale : Arrays.asList(Locale.FRENCH, Locale.ENGLISH)) {
            ...
            System.out.println(String.format("[%s] %s : %s", locale.toString(),
