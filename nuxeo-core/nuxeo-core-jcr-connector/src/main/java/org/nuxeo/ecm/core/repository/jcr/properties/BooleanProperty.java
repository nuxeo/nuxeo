 ...
 *
 */
public class BooleanProperty extends JCRScalarProperty {

    BooleanProperty(JCRNodeProxy parent, Property property, Field field) {
        ...
        if (value != null) {
            try {
                prop = parent.getNode().setProperty(
                        field.getName().getPrefixedName(), (Boolean) value);
