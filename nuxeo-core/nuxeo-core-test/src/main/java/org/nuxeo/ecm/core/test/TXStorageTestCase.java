...
/**
 * Transactional Storage Test Case.
 * <p>
...
public abstract class TXStorageTestCase extends StorageTestCase {
    ...
    protected boolean hasPoolingConfig() {
        return database.isVCSH2() || database.isVCSPostgreSQL();
    }

    protected boolean useSingleConnectionMode() {
        return ConnectionHelper.useSingleConnection(ConnectionHelper.getPseudoDataSourceNameForRepository(database.getRepositoryName()));
    }
