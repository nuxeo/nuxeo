 ...
 */
public class TestMongoDBRepositorySecurity extends MongoDBRepositoryTestCase {

    @Override
    protected void initRepository() throws Exception {
        deployContrib("org.nuxeo.ecm.core.storage.mongodb.tests", "OSGI-INF/test-repo-perm.xml");
    ...
    public void testGetParentDocuments() throws ClientException {
        ...
        if (session.isNegativeAclAllowed()) { // always false for MongoDB
            ACP acp = new ACPImpl();
