...
public class ClientLoginModule implements LoginModule {
      ...
      Map sharedState, Map options)
   {
      ...
      // the principal class to use when no principal is provided by leading modules
   ...
   public Principal createPrincipal(final String name) throws LoginException {
       if (principalClass != null) {
           try {
               ...
               LoginException ee = new LoginException("Failed to instantiate principal : "+principalClass);
               ee.initCause(e);
               throw ee;
           }
       }
