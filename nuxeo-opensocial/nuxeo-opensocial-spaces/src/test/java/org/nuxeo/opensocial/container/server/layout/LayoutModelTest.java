...
public class LayoutModelTest {
    ...
    public void iCanCreateACustomLayout() throws IOException {
        ...
        assertEquals(layout.getBodySize()
                .getCSS(), "doc");
        assertEquals(layout.getBodySize()
                .getSize(), 750);
        ...
        assertEquals(layout2.getBodySize()
                .getCSS(), "custom-doc");
        assertEquals(layout2.getBodySize()
                .getSize(), 40);
