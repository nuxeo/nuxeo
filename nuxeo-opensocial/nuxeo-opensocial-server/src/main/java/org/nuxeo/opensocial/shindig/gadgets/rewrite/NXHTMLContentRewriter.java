...
/**
 * This class extends the vanilla HTMLContentRewriter by adding the
 * INPUT tag to replace its src property
 * @author dmetzler
 *
 */
public class NXHTMLContentRewriter implements GadgetRewriter, RequestRewriter {
  ...
  @Inject
  public NXHTMLContentRewriter(ContentRewriterFeatureFactory rewriterFeatureFactory,
