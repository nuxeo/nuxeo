...
function mkRow(document, i) {
    ...
    if(document.folderish == 1) {
      htmlRow+="<td><a title=\""+ document.title +"\" onclick=\"followPath('" + document.name + "');return false;\" />";
    } else {
      htmlRow+="<td><a target = \"_top\" title=\""+ document.title +"\" href=\"/nuxeo/" + document.url + "\" />";
    }
    htmlRow+=document.title;
    if(document.folderish == 0 && false ) {
      htmlRow+="<a href=\"\"><img src=\"/nuxeo/icons/download.png\" alt=\"Download\"></a>";
    }
