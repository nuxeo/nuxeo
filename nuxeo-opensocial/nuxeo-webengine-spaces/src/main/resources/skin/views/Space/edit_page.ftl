...
<table class="formFill">
    <tbody>
        <tr>
            <td>Name:</td>
            <td><input type="text" name="name" readonly="readonly" value="${This.space.name}" size="40"></td>
        </tr>
        <tr>
            <td>Title:</td>
            <td><input type="text" name="dc:title" value="${This.space.title}" size="40"/></td>
        </tr>
        <tr>
            <td colspan="2">Description</td>
        </tr>
        <tr>
            <td colspan="2"><textarea name="dc:description" cols="54">${This.space.description}</textarea></td>
        </tr>
