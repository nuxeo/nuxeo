...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_3y3h1f9nje4cbw4g.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_9kli5p9jje4cbw3i.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_cdvv479lje4cbw3q.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_5gdbfh9oje4cbw4q = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_6v88of9ije4cbw3g = {
    open: function (editor) {
      var minWidth = $_9kli5p9jje4cbw3i.getDialogMinWidth(editor);
      var minHeight = $_9kli5p9jje4cbw3i.getDialogMinHeight(editor);
      var currentLanguage = $_5gdbfh9oje4cbw4q.getCurrentLanguage(editor);
      var currentLanguages = $_5gdbfh9oje4cbw4q.getLanguages(editor);
      var currentCode = $_cdvv479lje4cbw3q.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_cdvv479lje4cbw3q.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_3y3h1f9nje4cbw4g.isCodeSample(node)) {
        $_6v88of9ije4cbw3g.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_6z79sv9hje4cbw3e = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_3y3h1f9nje4cbw4g.trimArg($_3y3h1f9nje4cbw4g.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_3y3h1f9nje4cbw4g.trimArg($_3y3h1f9nje4cbw4g.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_94ql049pje4cbw4u = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_9kli5p9jje4cbw3i.getContentCss(editor);
  ...
  var $_d3n7kf9qje4cbw4w = { loadCss: loadCss };
  ...
  var $_3cdeex9rje4cbw4y = { register: register$1 };

  var addedInlineCss = Cell(false);
  PluginManager.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_94ql049pje4cbw4u.setup(editor);
    $_3cdeex9rje4cbw4y.register(editor);
    $_6z79sv9hje4cbw3e.register(editor);
    editor.on('init', function () {
      $_d3n7kf9qje4cbw4w.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_3y3h1f9nje4cbw4g.isCodeSample(ev.target)) {
        $_6v88of9ije4cbw3g.open(editor);
      }
    });
  });
