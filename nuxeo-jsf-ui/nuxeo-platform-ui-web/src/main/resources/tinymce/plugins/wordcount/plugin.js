...
var wordcount = (function () {
  ...
  var $_ek9n2as4je4cbzk6 = {
    each: each,
    map: map
  };

  var SETS$1 = $_7y9rexs2je4cbzk0.SETS;
  var OTHER = $_7y9rexs2je4cbzk0.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_ek9n2as4je4cbzk6.map(string.split(''), memoized);
  };
  var $_af03g3s3je4cbzk4 = { classify: classify };

  var ci = $_7y9rexs2je4cbzk0.characterIndices;
  ...
  var $_7pz048s5je4cbzk8 = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_7y9rexs2je4cbzk0.EMPTY_STRING;
  var WHITESPACE$1 = $_7y9rexs2je4cbzk0.WHITESPACE;
  var PUNCTUATION$1 = $_7y9rexs2je4cbzk0.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_af03g3s3je4cbzk4.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_7pz048s5je4cbzk8.isWordBoundary(map, i)) {
  ...
  var $_7tbu9fs1je4cbzjx = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_7tbu9fs1je4cbzjx.getWords(getTextContent(editor)).length;
  };
  var $_fmwus4s0je4cbzjv = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_fmwus4s0je4cbzjv.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_1wp7ujrzje4cbzju = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_fmwus4s0je4cbzjv.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_dumgdks6je4cbzkh = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_dumgdks6je4cbzkh.setup(editor);
    return $_1wp7ujrzje4cbzju.get(editor);
  });
  function Plugin () {
  }
