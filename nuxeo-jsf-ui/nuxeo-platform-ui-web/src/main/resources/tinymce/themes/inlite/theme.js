...
var inlite = (function () {
  ...
  var $_6kpyhk16ije4cc39n = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_dq9rfg16mje4cc39s.fromClientRect(clientRect)) : null;
  };
  var $_f9vblj16lje4cc39r = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_g0r36k16kje4cc39p.result(predicateIds[i].id, $_f9vblj16lje4cc39r.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_g0r36k16kje4cc39p.result(predicateIds[x].id, $_f9vblj16lje4cc39r.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_g0r36k16kje4cc39p.result(id, $_f9vblj16lje4cc39r.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_g0r36k16kje4cc39p.result(id, $_f9vblj16lje4cc39r.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_crmgvw16vje4cc3a8.isArray(value)) {
      return value;
    } else if ($_crmgvw16vje4cc3a8.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_crmgvw16vje4cc3a8.isBoolean(value)) {
  ...
  var $_63erkl16uje4cc3a6 = {
    getStringOr: getByTypeOr($_crmgvw16vje4cc3a8.isString),
    getBoolOr: getByTypeOr($_crmgvw16vje4cc3a8.isBoolean),
    getNumberOr: getByTypeOr($_crmgvw16vje4cc3a8.isNumber),
    getHandlerOr: getByTypeOr($_crmgvw16vje4cc3a8.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_crmgvw16vje4cc3a8.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_dq9rfg16mje4cc39s.toClientRect(targetRect),
        contentAreaRect: $_dq9rfg16mje4cc39s.toClientRect(contentAreaRect),
        panelRect: $_dq9rfg16mje4cc39s.toClientRect(panelRect)
      });
      return $_dq9rfg16mje4cc39s.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_63erkl16uje4cc3a6.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_63erkl16uje4cc3a6.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_63erkl16uje4cc3a6.getHandlerOr(editor, 'inline_toolbar_position_handler', $_6pjc2316wje4cc3aa.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_9eti2016rje4cc39x.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_epw5y216sje4cc39y.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_epw5y216sje4cc39y.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_do52gi16qje4cc39w = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_6kpyhk16ije4cc39n.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_57kosy16nje4cc39t.fromContextToolbars(toolbars);
    result = $_g0r36k16kje4cc39p.match(editor, [
      $_2pcov416jje4cc39o.element(elements[0], contextToolbarsPredicateIds),
      $_13so8316pje4cc39u.textSelection('text'),
      $_13so8316pje4cc39u.emptyTextBlock(elements, 'insert'),
      $_2pcov416jje4cc39o.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_g0r36k16kje4cc39p.match(editor, [$_13so8316pje4cc39u.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_do52gi16qje4cc39w.load(editor, function () {
  ...
  var $_7s0nr816eje4cc39c = { renderUI: renderUI };
  ...
  var never$1 = $_ekdjxs171je4cc3aq.never;
  var always$1 = $_ekdjxs171je4cc3aq.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_ekdjxs171je4cc3aq.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_cb91li178je4cc3bi.parseBox(settings.border);
      self.paddingBox = $_cb91li178je4cc3bi.parseBox(settings.padding);
      self.marginBox = $_cb91li178je4cc3bi.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_1h3ay617gje4cc3cd.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_cb91li178je4cc3bi.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_cb91li178je4cc3bi.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_cb91li178je4cc3bi.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_argll817fje4cc3cc.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_1h3ay617gje4cc3cd.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_1h3ay617gje4cc3cd.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_7ddo5517hje4cc3cg = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_1h3ay617gje4cc3cd.getUiContainer(self);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_1h3ay617gje4cc3cd.inheritUiContainer(this, this._tooltip);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_87pup016zje4cc3ah.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_87pup016zje4cc3ah.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_cb91li178je4cc3bi.parseBox(self.settings.border);
          ...
          self.borderBox = $_cb91li178je4cc3bi.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_7s0nr816eje4cc39c.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_g0b8uf16dje4cc39a = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_ao1u8a180je4cc3em.resolve(name, scope);
  };
  ...
  var $_5afana17zje4cc3ek = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_5afana17zje4cc3ek.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_8wlmfg17xje4cc3eg = { blobToBase64: blobToBase64 };
  ...
  var $_75lue183je4cc3eo = { pickFile: pickFile };
  ...
  var $_24w9uf185je4cc3es = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_9zdhk1187je4cc3ev.create(dom, selection.getRng());
    Tools.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_9zdhk1187je4cc3ev.resolve(dom, bookmark));
  };
  ...
  var $_4h4rwu186je4cc3et = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_24w9uf185je4cc3es.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_4h4rwu186je4cc3et.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_awltly184je4cc3eq.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_75lue183je4cc3eo.pickFile().then(function (files) {
          var blob = files[0];
          $_8wlmfg17xje4cc3eg.blobToBase64(blob).then(function (base64) {
            $_awltly184je4cc3eq.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_awltly184je4cc3eq.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_utdb517wje4cc3ee = { addToEditor: addToEditor };
  ...
  var $_a6nw1r18bje4cc3f3 = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_bgp1rt18dje4cc3f8.isAbsolute(href) && $_bgp1rt18dje4cc3f8.isDomainLike(href) ? askAboutPrefix(editor, href) : Promise.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_awltly184je4cc3eq.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_awltly184je4cc3eq.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_b24vtb18cje4cc3f5 = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_crmgvw16vje4cc3a8.isArray(items)) {
      return items;
    } else if ($_crmgvw16vje4cc3a8.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    Tools.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_crmgvw16vje4cc3a8.isFunction(button)) {
            button = button();
          }
  ...
  var $_4dq7kp18eje4cc3fm = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return Tools.map(toolbars, function (toolbar) {
        return $_4dq7kp18eje4cc3fm.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_4dq7kp18eje4cc3fm.create(editor, 'text', $_epw5y216sje4cc39y.getTextSelectionToolbarItems(editor)),
        $_4dq7kp18eje4cc3fm.create(editor, 'insert', $_epw5y216sje4cc39y.getInsertToolbarItems(editor)),
        $_b24vtb18cje4cc3f5.createQuickLinkForm(editor, hide)
      ]);
      return Factory.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_epw5y216sje4cc39y.getPositionHandler(editor);
      contentAreaRect = $_f9vblj16lje4cc39r.getContentAreaRect(editor);
      panelRect = DOMUtils.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_6pjc2316wje4cc3aa.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_6pjc2316wje4cc3aa.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_a6nw1r18bje4cc3f3.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_6pjc2316wje4cc3aa.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_f9vblj16lje4cc39r.getContentAreaRect(editor);
        panelRect = DOMUtils.DOM.getRect(panel.getEl());
        result = $_6pjc2316wje4cc3aa.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_6pjc2316wje4cc3aa.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_9eti2016rje4cc39x.fireBeforeRenderUI(editor);
  ...
  var $_8c861m191je4cc3i7 = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_ekdjxs171je4cc3aq.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_4nojle192je4cc3i8 = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_702tl8196je4cc3ij = { cached: cached };

  var $_bts6t7198je4cc3im = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_bts6t7198je4cc3im.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_bts6t7198je4cc3im.ELEMENT);
  var isText = isType$1($_bts6t7198je4cc3im.TEXT);
  var isDocument = isType$1($_bts6t7198je4cc3im.DOCUMENT);
  var $_2hrrci197je4cc3ik = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_2hrrci197je4cc3ik.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_702tl8196je4cc3ij.cached(function () {
    return getBody($_4nojle192je4cc3i8.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_4nojle192je4cc3i8.fromDom(body);
  };
  var $_6zd9nj195je4cc3ih = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_87pup016zje4cc3ah.each(fields, function (name, i) {
        struct[name] = $_ekdjxs171je4cc3aq.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_3o5b0019aje4cc3iw.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_87pup016zje4cc3ah.each(array, function (a) {
      if (!$_3o5b0019aje4cc3iw.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_87pup016zje4cc3ah.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_4al32m19fje4cc3j5.validateStrArr('required', required);
    $_4al32m19fje4cc3j5.validateStrArr('optional', optional);
    $_4al32m19fje4cc3j5.checkDupes(everything);
    return function (obj) {
      var keys = $_79x6et19eje4cc3j2.keys(obj);
      var allReqd = $_87pup016zje4cc3ah.forall(required, function (req) {
        return $_87pup016zje4cc3ah.contains(keys, req);
      });
      if (!allReqd)
        $_4al32m19fje4cc3j5.reqMessage(required, keys);
      var unsupported = $_87pup016zje4cc3ah.filter(keys, function (key) {
        return !$_87pup016zje4cc3ah.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_4al32m19fje4cc3j5.unsuppMessage(unsupported);
      var r = {};
      $_87pup016zje4cc3ah.each(required, function (req) {
        r[req] = $_ekdjxs171je4cc3aq.constant(obj[req]);
      });
      $_87pup016zje4cc3ah.each(optional, function (opt) {
        r[opt] = $_ekdjxs171je4cc3aq.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_aigqed19bje4cc3iy = {
    immutable: Immutable,
  ...
  var $_frmw0x19gje4cc3j7 = { toArray: toArray };

  var node = function () {
    var f = $_5afana17zje4cc3ek.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_a4h63c19mje4cc3k0.unknown()
    });
  };
  ...
  var $_amq5l819lje4cc3jl = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_ekdjxs171je4cc3aq.constant(edge),
    chrome: $_ekdjxs171je4cc3aq.constant(chrome),
    ie: $_ekdjxs171je4cc3aq.constant(ie),
    opera: $_ekdjxs171je4cc3aq.constant(opera),
    firefox: $_ekdjxs171je4cc3aq.constant(firefox),
    safari: $_ekdjxs171je4cc3aq.constant(safari)
  };
  ...
  var $_9r0ic19nje4cc3k2 = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_ekdjxs171je4cc3aq.constant(windows$1),
    ios: $_ekdjxs171je4cc3aq.constant(ios),
    android: $_ekdjxs171je4cc3aq.constant(android),
    linux: $_ekdjxs171je4cc3aq.constant(linux),
    osx: $_ekdjxs171je4cc3aq.constant(osx),
    solaris: $_ekdjxs171je4cc3aq.constant(solaris),
    freebsd: $_ekdjxs171je4cc3aq.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_ekdjxs171je4cc3aq.constant(isiPad),
      isiPhone: $_ekdjxs171je4cc3aq.constant(isiPhone),
      isTablet: $_ekdjxs171je4cc3aq.constant(isTablet),
      isPhone: $_ekdjxs171je4cc3aq.constant(isPhone),
      isTouch: $_ekdjxs171je4cc3aq.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_ekdjxs171je4cc3aq.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_87pup016zje4cc3ah.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_a4h63c19mje4cc3k0.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_a4h63c19mje4cc3k0.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_9b8rrd19sje4cc3kh.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_9b8rrd19sje4cc3kh.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_9b8rrd19sje4cc3kh.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_9b8rrd19sje4cc3kh.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_a1dl7n19tje4cc3kk.head(str).bind(function (head) {
      return $_a1dl7n19tje4cc3kk.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_4vfs2f19rje4cc3kf.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_4vfs2f19rje4cc3kf.contains(uastring, 'edge/') && $_4vfs2f19rje4cc3kf.contains(uastring, 'chrome') && $_4vfs2f19rje4cc3kf.contains(uastring, 'safari') && $_4vfs2f19rje4cc3kf.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_4vfs2f19rje4cc3kf.contains(uastring, 'chrome') && !$_4vfs2f19rje4cc3kf.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_4vfs2f19rje4cc3kf.contains(uastring, 'msie') || $_4vfs2f19rje4cc3kf.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_4vfs2f19rje4cc3kf.contains(uastring, 'safari') || $_4vfs2f19rje4cc3kf.contains(uastring, 'mobile/')) && $_4vfs2f19rje4cc3kf.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_4vfs2f19rje4cc3kf.contains(uastring, 'iphone') || $_4vfs2f19rje4cc3kf.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_b66lna19qje4cc3ka = {
    browsers: $_ekdjxs171je4cc3aq.constant(browsers),
    oses: $_ekdjxs171je4cc3aq.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_b66lna19qje4cc3ka.browsers();
    var oses = $_b66lna19qje4cc3ka.oses();
    var browser = $_dnxp5e19pje4cc3k8.detectBrowser(browsers, userAgent).fold($_amq5l819lje4cc3jl.unknown, $_amq5l819lje4cc3jl.nu);
    var os = $_dnxp5e19pje4cc3k8.detectOs(oses, userAgent).fold($_9r0ic19nje4cc3k2.unknown, $_9r0ic19nje4cc3k2.nu);
  ...
  var $_cwi3xn19kje4cc3jj = { detect: detect$2 };

  var detect$3 = $_702tl8196je4cc3ij.cached(function () {
    var userAgent = navigator.userAgent;
    return $_cwi3xn19kje4cc3jj.detect(userAgent);
  });
  var $_f2u93819jje4cc3jf = { detect: detect$3 };

  var ELEMENT = $_bts6t7198je4cc3im.ELEMENT;
  var DOCUMENT = $_bts6t7198je4cc3im.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_87pup016zje4cc3ah.map(base.querySelectorAll(selector), $_4nojle192je4cc3i8.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_4nojle192je4cc3i8.fromDom);
  };
  var $_esvegq19uje4cc3kl = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_87pup016zje4cc3ah.exists(elements, $_ekdjxs171je4cc3aq.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_1fyznu19ije4cc3je.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_f2u93819jje4cc3jf.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_fczkos19hje4cc3j8 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_esvegq19uje4cc3kl.is
  };

  var owner = function (element) {
    return $_4nojle192je4cc3i8.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_4nojle192je4cc3i8.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_4nojle192je4cc3i8.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_4nojle192je4cc3i8.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_87pup016zje4cc3ah.findIndex(kin, function (elem) {
        return $_fczkos19hje4cc3j8.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_3o5b0019aje4cc3iw.isFunction(isRoot) ? isRoot : $_ekdjxs171je4cc3aq.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_4nojle192je4cc3i8.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_87pup016zje4cc3ah.filter(elements, function (x) {
        return !$_fczkos19hje4cc3j8.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_4nojle192je4cc3i8.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_4nojle192je4cc3i8.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_4nojle192je4cc3i8.fromDom);
  };
  var prevSiblings = function (element) {
    return $_87pup016zje4cc3ah.reverse($_frmw0x19gje4cc3j7.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_frmw0x19gje4cc3j7.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_87pup016zje4cc3ah.map(dom.childNodes, $_4nojle192je4cc3i8.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_4nojle192je4cc3i8.fromDom);
  };
  ...
  var spot = $_aigqed19bje4cc3iy.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_6urrtl199je4cc3in = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_6zd9nj195je4cc3ih.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_87pup016zje4cc3ah.filter($_6urrtl199je4cc3in.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_87pup016zje4cc3ah.filter($_6urrtl199je4cc3in.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_87pup016zje4cc3ah.filter($_6urrtl199je4cc3in.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_87pup016zje4cc3ah.each($_6urrtl199je4cc3in.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_esvegq19uje4cc3kl.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_1exg9o194je4cc3ie.ancestors(scope, function (e) {
      return $_esvegq19uje4cc3kl.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_1exg9o194je4cc3ie.siblings(scope, function (e) {
      return $_esvegq19uje4cc3kl.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_1exg9o194je4cc3ie.children(scope, function (e) {
      return $_esvegq19uje4cc3kl.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_esvegq19uje4cc3kl.all(selector, scope);
  };
  var $_g95zug193je4cc3ic = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_87pup016zje4cc3ah.map($_g95zug193je4cc3ic.descendants($_4nojle192je4cc3i8.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_8c861m191je4cc3i7.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$4('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_ekdjxs171je4cc3aq.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_87pup016zje4cc3ah.map($_87pup016zje4cc3ah.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_87pup016zje4cc3ah.map($_87pup016zje4cc3ah.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_87pup016zje4cc3ah.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_ed7fck190je4cc3hz = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_ekdjxs171je4cc3aq.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_87pup016zje4cc3ah.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_87pup016zje4cc3ah.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_87pup016zje4cc3ah.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_87pup016zje4cc3ah.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_87pup016zje4cc3ah.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_ed7fck190je4cc3hz.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_3o5b0019aje4cc3iw.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_6zd9nj195je4cc3ih.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_4nojle192je4cc3i8.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_4nojle192je4cc3i8.fromDom(element.parentNode), function (x) {
      return !$_fczkos19hje4cc3j8.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_87pup016zje4cc3ah.find(scope.dom().childNodes, $_ekdjxs171je4cc3aq.compose(predicate, $_4nojle192je4cc3i8.fromDom));
    return result.map($_4nojle192je4cc3i8.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_4nojle192je4cc3i8.fromDom(element.childNodes[i])))
          return Option.some($_4nojle192je4cc3i8.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_esvegq19uje4cc3kl.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_amydbw1a0je4cc3l5.ancestor(scope, function (e) {
      return $_esvegq19uje4cc3kl.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_amydbw1a0je4cc3l5.sibling(scope, function (e) {
      return $_esvegq19uje4cc3kl.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_amydbw1a0je4cc3l5.child(scope, function (e) {
      return $_esvegq19uje4cc3kl.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_esvegq19uje4cc3kl.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_esvegq19uje4cc3kl.is, ancestor$1, scope, selector, isRoot);
  };
  var $_c8ae4q19zje4cc3l3 = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_5kw4hd1a3je4cc3lg.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_5kw4hd1a3je4cc3lg.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_5kw4hd1a3je4cc3lg.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_5kw4hd1a3je4cc3lg.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_5kw4hd1a3je4cc3lg.postRenderFormat(editor, name)
      });
    });
  };
  var $_4tjcqk1a2je4cc3lf = { register: register };
  ...
  var getFontProp = function (propName) {
    return function (rootElm, elm) {
      return Option.from(elm).map($_4nojle192je4cc3i8.fromDom).filter($_2hrrci197je4cc3ik.isElement).bind(function (element) {
        return getSpecifiedFontProp(propName, rootElm, element.dom()).or(getComputedFontProp(propName, element.dom()));
      }).getOr('');
    };
  };
  var $_ghsood1a5je4cc3ll = {
    getFontSize: getFontProp('fontSize'),
    getFontFamily: $_ekdjxs171je4cc3aq.compose(normalizeFontFamily, getFontProp('fontFamily')),
    toPt: toPt
  };
  ...
  var createFontNameListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        var fontFamily = $_ghsood1a5je4cc3ll.getFontFamily(editor.getBody(), e.element);
  ...
  var $_f702tz1a4je4cc3li = { register: register$1 };
  ...
  var createFontSizeListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        ...
        px = $_ghsood1a5je4cc3ll.getFontSize(editor.getBody(), e.element);
        if (px) {
          for (precision = 3; !match && precision >= 0; precision--) {
            pt = $_ghsood1a5je4cc3ll.toPt(px, precision);
  ...
  var $_83mvx91a6je4cc3lq = { register: register$2 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_5kw4hd1a3je4cc3lg.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_60h6l91a7je4cc3m2 = { register: register$3 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_5kw4hd1a3je4cc3lg.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return Tools.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_5kw4hd1a3je4cc3lg.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_fvyvme1a8je4cc3m6 = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_87pup016zje4cc3ah.flatten(Tools.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_87pup016zje4cc3ah.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_87pup016zje4cc3ah.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_4dxqq01a9je4cc3m9 = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_5kw4hd1a3je4cc3lg.postRenderFormat(editor, name),
        onclick: $_5kw4hd1a3je4cc3lg.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_5kw4hd1a3je4cc3lg.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_3ouv3n1aaje4cc3md = { register: register$6 };
  ...
  var $_78mugx1abje4cc3mg = { register: register$7 };
  ...
  var $_1bfrs81acje4cc3mh = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      Env.container = $_c8ae4q19zje4cc3l3.descendant($_4nojle192je4cc3i8.fromDom(document.body), editor.settings.ui_container).fold($_ekdjxs171je4cc3aq.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_fvyvme1a8je4cc3m6.register(editor);
    $_4tjcqk1a2je4cc3lf.register(editor);
    $_3ouv3n1aaje4cc3md.register(editor);
    $_78mugx1abje4cc3mg.register(editor);
    $_83mvx91a6je4cc3lq.register(editor);
    $_f702tz1a4je4cc3li.register(editor);
    $_60h6l91a7je4cc3m2.register(editor);
    $_1bfrs81acje4cc3mh.register(editor);
    $_4dxqq01a9je4cc3m9.register(editor);
  };
  var $_ofpcf19yje4cc3kz = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_3o5b0019aje4cc3iw.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_3o5b0019aje4cc3iw.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_argll817fje4cc3cc,
      Control: Control$1,
      Factory: Factory,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_49husg17tje4cc3e7,
      Panel: Panel,
      Movable: $_7ddo5517hje4cc3cg,
      Resizable: $_2cud0317uje4cc3ea,
      ...
      FormatControls: $_ofpcf19yje4cc3kz,
  ...
  ThemeManager.add('inlite', function (editor) {
    var panel = create$3();
    $_ofpcf19yje4cc3kz.setup(editor);
    $_utdb517wje4cc3ee.addToEditor(editor, panel);
    return $_g0b8uf16dje4cc39a.get(editor, panel);
  });
  function Theme () {
  }
