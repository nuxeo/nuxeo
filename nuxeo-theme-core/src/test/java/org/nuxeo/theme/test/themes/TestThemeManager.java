...
public class TestThemeManager extends NXRuntimeTestCase {
	...
	public void testGetThemeNames() {
		...
		assertTrue(ThemeManager.getThemeNames("jsf-facelets")
				.contains("theme4"));
	...
	public void testDuplicateElement() throws ThemeException {
		...
		// compare formats
		assertSame(widget, ElementFormatter.getFormatsFor(duplicate).iterator()
				.next());
	}

	public void testDuplicateFragment() throws ThemeException {
		DummyFragment fragment = (DummyFragment) FragmentFactory
	...
	public void testStyleInheritance() throws ThemeException {
		...
		assertTrue(ThemeManager.listAncestorFormatsOf(style)
				.contains(ancestor1));
		...
		assertTrue(ThemeManager.listFormatsDirectlyInheritingFrom(ancestor1)
				.contains(style));
		assertTrue(ThemeManager.listFormatsDirectlyInheritingFrom(ancestor2)
				.contains(ancestor1));
		assertTrue(ThemeManager.listFormatsDirectlyInheritingFrom(ancestor3)
				.contains(ancestor2));
		...
		assertFalse(ThemeManager.listFormatsDirectlyInheritingFrom(ancestor1)
				.contains(style));
		assertTrue(ThemeManager.listFormatsDirectlyInheritingFrom(ancestor2)
				.contains(style));
		assertTrue(ThemeManager.listFormatsDirectlyInheritingFrom(ancestor2)
		...
		assertNull(ThemeManager.getAncestorFormatOf(style));
		assertFalse(ThemeManager.listFormatsDirectlyInheritingFrom(ancestor2)
				.contains(style));
		...
		assertTrue(ThemeManager.listAncestorFormatsOf(style1)
				.contains(ancestor));
		assertTrue(ThemeManager.listAncestorFormatsOf(style2)
				.contains(ancestor));
		assertTrue(ThemeManager.listFormatsDirectlyInheritingFrom(ancestor)
				.contains(style1));
		assertTrue(ThemeManager.listFormatsDirectlyInheritingFrom(ancestor)
				.contains(style2));
