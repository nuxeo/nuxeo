...
public class DocumentDescriptor  implements java.io.Serializable {
    ...
    /**
     * Gets the id value for this DocumentDescriptor.
     * 
     * @return id
     */
    ...
    /**
     * Sets the id value for this DocumentDescriptor.
     * 
     * @param id
     */
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ws.api.platform.ecm.nuxeo.org/jaws", "id"));
