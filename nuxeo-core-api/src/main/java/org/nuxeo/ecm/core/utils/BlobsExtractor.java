...
public class BlobsExtractor {
    ...
    private boolean isInterestingBlobProperty(String path, String prefix) {
        if (pathProperties == null && excludedPathProperties == null) {
            return true;
        } else if (pathProperties != null && pathProperties.size() == 0
                && excludedPathProperties != null
                && excludedPathProperties.size() == 0
                && Boolean.FALSE.equals(indexAllBinary)) {
            return true;
